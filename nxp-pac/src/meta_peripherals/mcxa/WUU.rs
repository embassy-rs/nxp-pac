...
impl defmt::Format for De {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "De {{ wude0: {=bool:?}, wude1: {=bool:?}, wude2: {=bool:?}, wude3: {=bool:?}, wude4: {=bool:?}, wude6: {=bool:?}, wude8: {=bool:?} }}",
            self.wude0(),
            self.wude1(),
            self.wude2(),
            self.wude3(),
...
impl Me {
    ...
    #[doc = "Module Interrupt Wake-up Enable for Module 10."]
    #[must_use]
    #[inline(always)]
    pub const fn wume10(&self) -> bool {
        let val = (self.0 >> 10usize) & 0x01;
        val != 0
    }
    #[doc = "Module Interrupt Wake-up Enable for Module 10."]
    #[inline(always)]
    pub const fn set_wume10(&mut self, val: bool) {
...
impl defmt::Format for Me {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Me {{ wume0: {=bool:?}, wume1: {=bool:?}, wume2: {=bool:?}, wume3: {=bool:?}, wume4: {=bool:?}, wume5: {=bool:?}, wume6: {=bool:?}, wume8: {=bool:?}, wume10: {=bool:?} }}",
            self.wume0(),
            self.wume1(),
            self.wume2(),
            self.wume3(),
