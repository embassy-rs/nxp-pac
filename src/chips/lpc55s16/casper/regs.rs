...
impl Intenset {
    ...
    #[doc = "Set if the accelerator should interrupt when done."]
    #[inline(always)]
    pub const fn set_done(&mut self, val: super::vals::IntensetDone) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
}
...
impl defmt::Format for Intenset {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Intenset {{ done: {:?} }}", self.done())
    }
}
...
impl Intstat {
    ...
    #[doc = "If set, interrupt is caused by accelerator being done."]
    #[inline(always)]
    pub const fn set_done(&mut self, val: super::vals::IntstatDone) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
}
...
impl defmt::Format for Intstat {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Intstat {{ done: {:?} }}", self.done())
    }
}
...
impl Status {
    ...
    #[doc = "Last carry value if operation produced a carry bit"]
    #[inline(always)]
    pub const fn set_carry(&mut self, val: super::vals::Carry) {
