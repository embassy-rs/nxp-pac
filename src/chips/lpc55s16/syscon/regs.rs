...
impl Ahbclkctrl0 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn rom(&self) -> super::vals::Ahbclkctrl0Rom {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::Ahbclkctrl0Rom::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the ROM."]
    #[inline(always)]
    pub const fn set_rom(&mut self, val: super::vals::Ahbclkctrl0Rom) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    #[doc = "Enables the clock for the SRAM Controller 1."]
    #[must_use]
    #[inline(always)]
    pub const fn sram_ctrl1(&self) -> super::vals::SramCtrl1 {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::SramCtrl1::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the SRAM Controller 1."]
    #[inline(always)]
    pub const fn set_sram_ctrl1(&mut self, val: super::vals::SramCtrl1) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    #[doc = "Enables the clock for the SRAM Controller 2."]
    #[must_use]
    #[inline(always)]
    pub const fn sram_ctrl2(&self) -> super::vals::SramCtrl2 {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::SramCtrl2::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the SRAM Controller 2."]
    #[inline(always)]
    pub const fn set_sram_ctrl2(&mut self, val: super::vals::SramCtrl2) {
    ...
    pub const fn flash(&self) -> super::vals::Flash {
        ...
        super::vals::Flash::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the Flash controller."]
    #[inline(always)]
    ...
    #[must_use]
    #[inline(always)]
    pub const fn iocon(&self) -> super::vals::Iocon {
        let val = (self.0 >> 13usize) & 0x01;
        super::vals::Iocon::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the I/O controller."]
    #[inline(always)]
    pub const fn set_iocon(&mut self, val: super::vals::Iocon) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dma0(&self) -> super::vals::Dma0 {
        let val = (self.0 >> 20usize) & 0x01;
        super::vals::Dma0::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the DMA0."]
    #[inline(always)]
    pub const fn set_dma0(&mut self, val: super::vals::Dma0) {
        self.0 = (self.0 & !(0x01 << 20usize)) | (((val.to_bits() as u32) & 0x01) << 20usize);
    }
    #[doc = "Enables the clock for the CRCGEN."]
    #[must_use]
    #[inline(always)]
    pub const fn crcgen(&self) -> super::vals::Ahbclkctrl0Crcgen {
        let val = (self.0 >> 21usize) & 0x01;
        super::vals::Ahbclkctrl0Crcgen::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the CRCGEN."]
    #[inline(always)]
    pub const fn set_crcgen(&mut self, val: super::vals::Ahbclkctrl0Crcgen) {
        self.0 = (self.0 & !(0x01 << 21usize)) | (((val.to_bits() as u32) & 0x01) << 21usize);
    }
    #[doc = "Enables the clock for the Watchdog Timer."]
    #[must_use]
    #[inline(always)]
    pub const fn wwdt(&self) -> super::vals::Wwdt {
        let val = (self.0 >> 22usize) & 0x01;
        super::vals::Wwdt::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the Watchdog Timer."]
    #[inline(always)]
    pub const fn set_wwdt(&mut self, val: super::vals::Wwdt) {
...
impl defmt::Format for Ahbclkctrl0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbclkctrl0 {{ rom: {:?}, sram_ctrl1: {:?}, sram_ctrl2: {:?}, flash: {:?}, fmc: {:?}, mux: {:?}, iocon: {:?}, gpio0: {:?}, gpio1: {:?}, pint: {:?}, gint: {:?}, dma0: {:?}, crcgen: {:?}, wwdt: {:?}, rtc: {:?}, mailbox: {:?}, adc: {:?} }}",
            self.rom(),
            self.sram_ctrl1(),
            self.sram_ctrl2(),
            self.flash(),
...
impl Ahbclkctrl1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn can(&self) -> super::vals::Can {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::Can::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the CAN."]
    #[inline(always)]
    pub const fn set_can(&mut self, val: super::vals::Can) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn fc(&self, n: usize) -> super::vals::Fc0 {
        assert!(n < 8usize);
    ...
    #[doc = "Enables the clock for the FC0."]
    #[inline(always)]
    pub const fn set_fc(&mut self, n: usize, val: super::vals::Fc0) {
        assert!(n < 8usize);
        let offs = 11usize + n * 1usize;
    ...
    #[must_use]
    #[inline(always)]
    pub const fn usb0_dev(&self) -> super::vals::Usb0Dev {
        let val = (self.0 >> 25usize) & 0x01;
        super::vals::Usb0Dev::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the USB0-FS device."]
    #[inline(always)]
    pub const fn set_usb0_dev(&mut self, val: super::vals::Usb0Dev) {
...
impl defmt::Format for Ahbclkctrl1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbclkctrl1 {{ mrt: {:?}, ostimer: {:?}, sct: {:?}, can: {:?}, utick: {:?}, fc[0]: {:?}, fc[1]: {:?}, fc[2]: {:?}, fc[3]: {:?}, fc[4]: {:?}, fc[5]: {:?}, fc[6]: {:?}, fc[7]: {:?}, timer2: {:?}, usb0_dev: {:?}, timer0: {:?}, timer1: {:?} }}",
            self.mrt(),
            self.ostimer(),
            self.sct(),
            self.can(),
...
impl Ahbclkctrl2 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dma1(&self) -> super::vals::Dma1 {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::Dma1::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the DMA1."]
    #[inline(always)]
    pub const fn set_dma1(&mut self, val: super::vals::Dma1) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn usb1_host(&self) -> super::vals::Usb1Host {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Usb1Host::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the USB1-HS Host."]
    #[inline(always)]
    pub const fn set_usb1_host(&mut self, val: super::vals::Usb1Host) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Enables the clock for the USB1-HS device."]
    #[must_use]
    #[inline(always)]
    pub const fn usb1_dev(&self) -> super::vals::Usb1Dev {
        let val = (self.0 >> 5usize) & 0x01;
        super::vals::Usb1Dev::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the USB1-HS device."]
    #[inline(always)]
    pub const fn set_usb1_dev(&mut self, val: super::vals::Usb1Dev) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val.to_bits() as u32) & 0x01) << 5usize);
    }
    #[doc = "Enables the clock for the USB1-HS RAM."]
    #[must_use]
    #[inline(always)]
    pub const fn usb1_ram(&self) -> super::vals::Usb1Ram {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::Usb1Ram::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the USB1-HS RAM."]
    #[inline(always)]
    pub const fn set_usb1_ram(&mut self, val: super::vals::Usb1Ram) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn cdog(&self) -> super::vals::Cdog {
        let val = (self.0 >> 11usize) & 0x01;
        super::vals::Cdog::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the code watchdog."]
    #[inline(always)]
    pub const fn set_cdog(&mut self, val: super::vals::Cdog) {
        self.0 = (self.0 & !(0x01 << 11usize)) | (((val.to_bits() as u32) & 0x01) << 11usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn sysctl(&self) -> super::vals::Sysctl {
        let val = (self.0 >> 15usize) & 0x01;
        super::vals::Sysctl::from_bits(val as u8)
    }
    #[doc = "SYSCTL block clock."]
    #[inline(always)]
    pub const fn set_sysctl(&mut self, val: super::vals::Sysctl) {
        self.0 = (self.0 & !(0x01 << 15usize)) | (((val.to_bits() as u32) & 0x01) << 15usize);
    }
    #[doc = "Enables the clock for the USB0-FS Host Master."]
    #[must_use]
    #[inline(always)]
    pub const fn usb0_hostm(&self) -> super::vals::Usb0Hostm {
        let val = (self.0 >> 16usize) & 0x01;
        super::vals::Usb0Hostm::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the USB0-FS Host Master."]
    #[inline(always)]
    pub const fn set_usb0_hostm(&mut self, val: super::vals::Usb0Hostm) {
        self.0 = (self.0 & !(0x01 << 16usize)) | (((val.to_bits() as u32) & 0x01) << 16usize);
    }
    #[doc = "Enables the clock for the USB0-FS Host Slave."]
    #[must_use]
    #[inline(always)]
    pub const fn usb0_hosts(&self) -> super::vals::Usb0Hosts {
        let val = (self.0 >> 17usize) & 0x01;
        super::vals::Usb0Hosts::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the USB0-FS Host Slave."]
    #[inline(always)]
    pub const fn set_usb0_hosts(&mut self, val: super::vals::Usb0Hosts) {
        self.0 = (self.0 & !(0x01 << 17usize)) | (((val.to_bits() as u32) & 0x01) << 17usize);
    }
    #[doc = "Enables the clock for the HASH_AES."]
    #[must_use]
    #[inline(always)]
    pub const fn hash_aes(&self) -> super::vals::HashAes {
        let val = (self.0 >> 18usize) & 0x01;
        super::vals::HashAes::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the HASH_AES."]
    #[inline(always)]
    pub const fn set_hash_aes(&mut self, val: super::vals::HashAes) {
        self.0 = (self.0 & !(0x01 << 18usize)) | (((val.to_bits() as u32) & 0x01) << 18usize);
    }
    #[doc = "Enables the clock for the PLU LUT."]
    #[must_use]
    #[inline(always)]
    pub const fn plulut(&self) -> super::vals::Plulut {
        let val = (self.0 >> 20usize) & 0x01;
        super::vals::Plulut::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the PLU LUT."]
    #[inline(always)]
    pub const fn set_plulut(&mut self, val: super::vals::Plulut) {
        self.0 = (self.0 & !(0x01 << 20usize)) | (((val.to_bits() as u32) & 0x01) << 20usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn analog_ctrl(&self) -> super::vals::AnalogCtrl {
        let val = (self.0 >> 27usize) & 0x01;
        super::vals::AnalogCtrl::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the analog control."]
    #[inline(always)]
    pub const fn set_analog_ctrl(&mut self, val: super::vals::AnalogCtrl) {
        self.0 = (self.0 & !(0x01 << 27usize)) | (((val.to_bits() as u32) & 0x01) << 27usize);
    }
    #[doc = "Enables the clock for the HS LSPI."]
    #[must_use]
    #[inline(always)]
    pub const fn hs_lspi(&self) -> super::vals::HsLspi {
        let val = (self.0 >> 28usize) & 0x01;
        super::vals::HsLspi::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the HS LSPI."]
    #[inline(always)]
    pub const fn set_hs_lspi(&mut self, val: super::vals::HsLspi) {
        self.0 = (self.0 & !(0x01 << 28usize)) | (((val.to_bits() as u32) & 0x01) << 28usize);
    }
    #[doc = "Enables the clock for the GPIO secure."]
    #[must_use]
    #[inline(always)]
    pub const fn gpio_sec(&self) -> super::vals::GpioSec {
        let val = (self.0 >> 29usize) & 0x01;
        super::vals::GpioSec::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the GPIO secure."]
    #[inline(always)]
    pub const fn set_gpio_sec(&mut self, val: super::vals::GpioSec) {
        self.0 = (self.0 & !(0x01 << 29usize)) | (((val.to_bits() as u32) & 0x01) << 29usize);
    }
    #[doc = "Enables the clock for the GPIO secure int."]
    #[must_use]
    #[inline(always)]
    pub const fn gpio_sec_int(&self) -> super::vals::GpioSecInt {
        let val = (self.0 >> 30usize) & 0x01;
        super::vals::GpioSecInt::from_bits(val as u8)
    }
    #[doc = "Enables the clock for the GPIO secure int."]
    #[inline(always)]
    pub const fn set_gpio_sec_int(&mut self, val: super::vals::GpioSecInt) {
        self.0 = (self.0 & !(0x01 << 30usize)) | (((val.to_bits() as u32) & 0x01) << 30usize);
    }
}
...
impl defmt::Format for Ahbclkctrl2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ahbclkctrl2 {{ dma1: {:?}, comp: {:?}, usb1_host: {:?}, usb1_dev: {:?}, usb1_ram: {:?}, usb1_phy: {:?}, freqme: {:?}, cdog: {:?}, rng: {:?}, sysctl: {:?}, usb0_hostm: {:?}, usb0_hosts: {:?}, hash_aes: {:?}, plulut: {:?}, timer3: {:?}, timer4: {:?}, puf: {:?}, casper: {:?}, analog_ctrl: {:?}, hs_lspi: {:?}, gpio_sec: {:?}, gpio_sec_int: {:?} }}",
            self.dma1(),
            self.comp(),
            self.usb1_host(),
            self.usb1_dev(),
...
impl Autoclkgateoverride {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn rom(&self) -> super::vals::AutoclkgateoverrideRom {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::AutoclkgateoverrideRom::from_bits(val as u8)
    }
    #[doc = "Control automatic clock gating of ROM controller."]
    #[inline(always)]
    pub const fn set_rom(&mut self, val: super::vals::AutoclkgateoverrideRom) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Control automatic clock gating of RAMX controller."]
    #[must_use]
    #[inline(always)]
    pub const fn ramx_ctrl(&self) -> super::vals::RamxCtrl {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::RamxCtrl::from_bits(val as u8)
    }
    #[doc = "Control automatic clock gating of RAMX controller."]
    #[inline(always)]
    pub const fn set_ramx_ctrl(&mut self, val: super::vals::RamxCtrl) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    #[doc = "Control automatic clock gating of RAM0 controller."]
    #[must_use]
    #[inline(always)]
    pub const fn ram0_ctrl(&self) -> super::vals::Ram0Ctrl {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Ram0Ctrl::from_bits(val as u8)
    }
    #[doc = "Control automatic clock gating of RAM0 controller."]
    #[inline(always)]
    pub const fn set_ram0_ctrl(&mut self, val: super::vals::Ram0Ctrl) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Control automatic clock gating of RAM1 controller."]
    #[must_use]
    #[inline(always)]
    pub const fn ram1_ctrl(&self) -> super::vals::Ram1Ctrl {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::Ram1Ctrl::from_bits(val as u8)
    }
    #[doc = "Control automatic clock gating of RAM1 controller."]
    #[inline(always)]
    pub const fn set_ram1_ctrl(&mut self, val: super::vals::Ram1Ctrl) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    #[doc = "Control automatic clock gating of RAM2 controller."]
    #[must_use]
    #[inline(always)]
    pub const fn ram2_ctrl(&self) -> super::vals::Ram2Ctrl {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Ram2Ctrl::from_bits(val as u8)
    }
    #[doc = "Control automatic clock gating of RAM2 controller."]
    #[inline(always)]
    pub const fn set_ram2_ctrl(&mut self, val: super::vals::Ram2Ctrl) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Control automatic clock gating of synchronous bridge controller 0."]
    #[must_use]
    #[inline(always)]
    pub const fn sync0_apb(&self) -> super::vals::Sync0Apb {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::Sync0Apb::from_bits(val as u8)
    }
    #[doc = "Control automatic clock gating of synchronous bridge controller 0."]
    #[inline(always)]
    pub const fn set_sync0_apb(&mut self, val: super::vals::Sync0Apb) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Control automatic clock gating of synchronous bridge controller 1."]
    #[must_use]
    #[inline(always)]
    pub const fn sync1_apb(&self) -> super::vals::Sync1Apb {
        let val = (self.0 >> 8usize) & 0x01;
        super::vals::Sync1Apb::from_bits(val as u8)
    }
    #[doc = "Control automatic clock gating of synchronous bridge controller 1."]
    #[inline(always)]
    pub const fn set_sync1_apb(&mut self, val: super::vals::Sync1Apb) {
        self.0 = (self.0 & !(0x01 << 8usize)) | (((val.to_bits() as u32) & 0x01) << 8usize);
    }
    #[doc = "Control automatic clock gating of CRCGEN controller."]
    #[must_use]
    #[inline(always)]
    pub const fn crcgen(&self) -> super::vals::AutoclkgateoverrideCrcgen {
        let val = (self.0 >> 11usize) & 0x01;
        super::vals::AutoclkgateoverrideCrcgen::from_bits(val as u8)
    }
    #[doc = "Control automatic clock gating of CRCGEN controller."]
    #[inline(always)]
    pub const fn set_crcgen(&mut self, val: super::vals::AutoclkgateoverrideCrcgen) {
        self.0 = (self.0 & !(0x01 << 11usize)) | (((val.to_bits() as u32) & 0x01) << 11usize);
    }
    #[doc = "Control automatic clock gating of DMA0 controller."]
    #[must_use]
    #[inline(always)]
    pub const fn sdma0(&self) -> super::vals::Sdma0 {
        let val = (self.0 >> 12usize) & 0x01;
        super::vals::Sdma0::from_bits(val as u8)
    }
    #[doc = "Control automatic clock gating of DMA0 controller."]
    #[inline(always)]
    pub const fn set_sdma0(&mut self, val: super::vals::Sdma0) {
        self.0 = (self.0 & !(0x01 << 12usize)) | (((val.to_bits() as u32) & 0x01) << 12usize);
    }
    #[doc = "Control automatic clock gating of DMA1 controller."]
    #[must_use]
    #[inline(always)]
    pub const fn sdma1(&self) -> super::vals::Sdma1 {
        let val = (self.0 >> 13usize) & 0x01;
        super::vals::Sdma1::from_bits(val as u8)
    }
    #[doc = "Control automatic clock gating of DMA1 controller."]
    #[inline(always)]
    pub const fn set_sdma1(&mut self, val: super::vals::Sdma1) {
        self.0 = (self.0 & !(0x01 << 13usize)) | (((val.to_bits() as u32) & 0x01) << 13usize);
    }
...
impl defmt::Format for Autoclkgateoverride {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Autoclkgateoverride {{ rom: {:?}, ramx_ctrl: {:?}, ram0_ctrl: {:?}, ram1_ctrl: {:?}, ram2_ctrl: {:?}, sync0_apb: {:?}, sync1_apb: {:?}, crcgen: {:?}, sdma0: {:?}, sdma1: {:?}, usb0: {:?}, syscon: {:?}, enableupdate: {:?} }}",
            self.rom(),
            self.ramx_ctrl(),
            self.ram0_ctrl(),
            self.ram1_ctrl(),
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct BootLock(pub u32);
impl BootLock {
    #[doc = "Control write access to BOOT_SEED_REG registers."]
    #[must_use]
    #[inline(always)]
    pub const fn lock_boot_seed(&self) -> super::vals::LockBootSeed {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::LockBootSeed::from_bits(val as u8)
    }
    #[doc = "Control write access to BOOT_SEED_REG registers."]
    #[inline(always)]
    pub const fn set_lock_boot_seed(&mut self, val: super::vals::LockBootSeed) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Control write access to HMAC_REG registers."]
    #[must_use]
    #[inline(always)]
    pub const fn lock_hmac(&self) -> super::vals::LockHmac {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::LockHmac::from_bits(val as u8)
    }
    #[doc = "Control write access to HMAC_REG registers."]
    #[inline(always)]
    pub const fn set_lock_hmac(&mut self, val: super::vals::LockHmac) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
}
impl Default for BootLock {
    #[inline(always)]
    fn default() -> BootLock {
        BootLock(0)
    }
...
impl defmt::Format for BootLock {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BootLock {{ lock_boot_seed: {:?}, lock_hmac: {:?} }}",
            self.lock_boot_seed(),
            self.lock_hmac()
        )
    }
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct BootSeedReg0(pub u32);
impl BootSeedReg0 {
...
impl Default for BootSeedReg0 {
    #[inline(always)]
    fn default() -> BootSeedReg0 {
        BootSeedReg0(0)
    }
}
impl core::fmt::Debug for BootSeedReg0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BootSeedReg0")
            .field("boot_seed_reg0", &self.boot_seed_reg0())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for BootSeedReg0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BootSeedReg0 {{ boot_seed_reg0: {=u32:?} }}",
            self.boot_seed_reg0()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct BootSeedReg1(pub u32);
impl BootSeedReg1 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for BootSeedReg1 {
    #[inline(always)]
    fn default() -> BootSeedReg1 {
        BootSeedReg1(0)
    }
}
impl core::fmt::Debug for BootSeedReg1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BootSeedReg1")
            .field("boot_seed_reg1", &self.boot_seed_reg1())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for BootSeedReg1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BootSeedReg1 {{ boot_seed_reg1: {=u32:?} }}",
            self.boot_seed_reg1()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct BootSeedReg2(pub u32);
impl BootSeedReg2 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for BootSeedReg2 {
    #[inline(always)]
    fn default() -> BootSeedReg2 {
        BootSeedReg2(0)
    }
}
impl core::fmt::Debug for BootSeedReg2 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BootSeedReg2")
            .field("boot_seed_reg2", &self.boot_seed_reg2())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for BootSeedReg2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BootSeedReg2 {{ boot_seed_reg2: {=u32:?} }}",
            self.boot_seed_reg2()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct BootSeedReg3(pub u32);
impl BootSeedReg3 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for BootSeedReg3 {
    #[inline(always)]
    fn default() -> BootSeedReg3 {
        BootSeedReg3(0)
    }
}
impl core::fmt::Debug for BootSeedReg3 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BootSeedReg3")
            .field("boot_seed_reg3", &self.boot_seed_reg3())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for BootSeedReg3 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BootSeedReg3 {{ boot_seed_reg3: {=u32:?} }}",
            self.boot_seed_reg3()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct BootSeedReg4(pub u32);
impl BootSeedReg4 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for BootSeedReg4 {
    #[inline(always)]
    fn default() -> BootSeedReg4 {
        BootSeedReg4(0)
    }
}
impl core::fmt::Debug for BootSeedReg4 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BootSeedReg4")
            .field("boot_seed_reg4", &self.boot_seed_reg4())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for BootSeedReg4 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BootSeedReg4 {{ boot_seed_reg4: {=u32:?} }}",
            self.boot_seed_reg4()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct BootSeedReg5(pub u32);
impl BootSeedReg5 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for BootSeedReg5 {
    #[inline(always)]
    fn default() -> BootSeedReg5 {
        BootSeedReg5(0)
    }
}
impl core::fmt::Debug for BootSeedReg5 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BootSeedReg5")
            .field("boot_seed_reg5", &self.boot_seed_reg5())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for BootSeedReg5 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BootSeedReg5 {{ boot_seed_reg5: {=u32:?} }}",
            self.boot_seed_reg5()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct BootSeedReg6(pub u32);
impl BootSeedReg6 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for BootSeedReg6 {
    #[inline(always)]
    fn default() -> BootSeedReg6 {
        BootSeedReg6(0)
    }
}
impl core::fmt::Debug for BootSeedReg6 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BootSeedReg6")
            .field("boot_seed_reg6", &self.boot_seed_reg6())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for BootSeedReg6 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BootSeedReg6 {{ boot_seed_reg6: {=u32:?} }}",
            self.boot_seed_reg6()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct BootSeedReg7(pub u32);
impl BootSeedReg7 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for BootSeedReg7 {
    #[inline(always)]
    fn default() -> BootSeedReg7 {
        BootSeedReg7(0)
    }
}
impl core::fmt::Debug for BootSeedReg7 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("BootSeedReg7")
            .field("boot_seed_reg7", &self.boot_seed_reg7())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for BootSeedReg7 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BootSeedReg7 {{ boot_seed_reg7: {=u32:?} }}",
            self.boot_seed_reg7()
        )
    }
}
...
impl Canclkdiv {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn reset(&self) -> super::vals::CanclkdivReset {
        let val = (self.0 >> 29usize) & 0x01;
        super::vals::CanclkdivReset::from_bits(val as u8)
    }
    #[doc = "Resets the divider counter."]
    #[inline(always)]
    pub const fn set_reset(&mut self, val: super::vals::CanclkdivReset) {
        self.0 = (self.0 & !(0x01 << 29usize)) | (((val.to_bits() as u32) & 0x01) << 29usize);
    }
    #[doc = "Halts the divider counter."]
    #[must_use]
    #[inline(always)]
    pub const fn halt(&self) -> super::vals::CanclkdivHalt {
        let val = (self.0 >> 30usize) & 0x01;
        super::vals::CanclkdivHalt::from_bits(val as u8)
    }
    #[doc = "Halts the divider counter."]
    #[inline(always)]
    pub const fn set_halt(&mut self, val: super::vals::CanclkdivHalt) {
        self.0 = (self.0 & !(0x01 << 30usize)) | (((val.to_bits() as u32) & 0x01) << 30usize);
    }
    #[doc = "Divider status flag."]
    #[must_use]
    #[inline(always)]
    pub const fn reqflag(&self) -> super::vals::CanclkdivReqflag {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::CanclkdivReqflag::from_bits(val as u8)
    }
    #[doc = "Divider status flag."]
    #[inline(always)]
    pub const fn set_reqflag(&mut self, val: super::vals::CanclkdivReqflag) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
...
impl defmt::Format for Canclksel {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Canclksel {{ sel: {=u8:?} }}", self.sel())
    }
}
#[doc = "Control CASPER integration."]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct CasperCtrl(pub u32);
impl CasperCtrl {
...
impl core::fmt::Debug for CasperCtrl {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CasperCtrl")
            .field("interleave", &self.interleave())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for CasperCtrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "CasperCtrl {{ interleave: {:?} }}", self.interleave())
    }
}
...
impl defmt::Format for Clk32kclksel {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Clk32kclksel {{ sel: {=bool:?} }}", self.sel())
    }
}
...
impl ClockCtrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn xtal32mhz_freqm_ena(&self) -> super::vals::Xtal32mhzFreqmEna {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::Xtal32mhzFreqmEna::from_bits(val as u8)
    }
    #[doc = "Enable XTAL32MHz clock for Frequency Measure module."]
    #[inline(always)]
    pub const fn set_xtal32mhz_freqm_ena(&mut self, val: super::vals::Xtal32mhzFreqmEna) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    #[doc = "Enable FRO 1MHz clock for Frequency Measure module and for UTICK."]
    #[must_use]
    #[inline(always)]
    pub const fn fro1mhz_utick_ena(&self) -> super::vals::Fro1mhzUtickEna {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Fro1mhzUtickEna::from_bits(val as u8)
    }
    #[doc = "Enable FRO 1MHz clock for Frequency Measure module and for UTICK."]
    #[inline(always)]
    pub const fn set_fro1mhz_utick_ena(&mut self, val: super::vals::Fro1mhzUtickEna) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Enable FRO 12MHz clock for Frequency Measure module."]
    #[must_use]
    #[inline(always)]
    pub const fn fro12mhz_freqm_ena(&self) -> super::vals::Fro12mhzFreqmEna {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::Fro12mhzFreqmEna::from_bits(val as u8)
    }
    #[doc = "Enable FRO 12MHz clock for Frequency Measure module."]
    #[inline(always)]
    pub const fn set_fro12mhz_freqm_ena(&mut self, val: super::vals::Fro12mhzFreqmEna) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    #[doc = "Enable FRO 96MHz clock for Frequency Measure module."]
    #[must_use]
    #[inline(always)]
    pub const fn fro_hf_freqm_ena(&self) -> super::vals::FroHfFreqmEna {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::FroHfFreqmEna::from_bits(val as u8)
    }
    #[doc = "Enable FRO 96MHz clock for Frequency Measure module."]
    #[inline(always)]
    pub const fn set_fro_hf_freqm_ena(&mut self, val: super::vals::FroHfFreqmEna) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ana_fro12m_clk_ena(&self) -> super::vals::AnaFro12mClkEna {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::AnaFro12mClkEna::from_bits(val as u8)
    }
    #[doc = "Enable FRO 12MHz clock for analog control of the FRO 192MHz."]
    #[inline(always)]
    pub const fn set_ana_fro12m_clk_ena(&mut self, val: super::vals::AnaFro12mClkEna) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Enable clock for cristal oscilator calibration."]
    #[must_use]
    #[inline(always)]
    pub const fn xo_cal_clk_ena(&self) -> super::vals::XoCalClkEna {
        let val = (self.0 >> 8usize) & 0x01;
        super::vals::XoCalClkEna::from_bits(val as u8)
    }
    #[doc = "Enable clock for cristal oscilator calibration."]
    #[inline(always)]
    pub const fn set_xo_cal_clk_ena(&mut self, val: super::vals::XoCalClkEna) {
        self.0 = (self.0 & !(0x01 << 8usize)) | (((val.to_bits() as u32) & 0x01) << 8usize);
    }
...
impl defmt::Format for ClockCtrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "ClockCtrl {{ xtal32mhz_freqm_ena: {:?}, fro1mhz_utick_ena: {:?}, fro12mhz_freqm_ena: {:?}, fro_hf_freqm_ena: {:?}, clkin_ena: {:?}, fro1mhz_clk_ena: {:?}, ana_fro12m_clk_ena: {:?}, xo_cal_clk_ena: {:?}, plu_deglitch_clk_ena: {:?} }}",
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct FlashremapLock(pub u32);
impl FlashremapLock {
...
impl core::fmt::Debug for FlashremapLock {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FlashremapLock")
            .field("lock", &self.lock())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for FlashremapLock {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "FlashremapLock {{ lock: {:?} }}", self.lock())
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct FlashremapOffset(pub u32);
impl FlashremapOffset {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for FlashremapOffset {
    #[inline(always)]
    fn default() -> FlashremapOffset {
        FlashremapOffset(0)
    }
}
impl core::fmt::Debug for FlashremapOffset {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FlashremapOffset")
            .field("flashremap_offset", &self.flashremap_offset())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for FlashremapOffset {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "FlashremapOffset {{ flashremap_offset: {=u32:?} }}",
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct FlashremapOffsetDp(pub u32);
...
impl Default for FlashremapOffsetDp {
    ...
    fn default() -> FlashremapOffsetDp {
        FlashremapOffsetDp(0)
    }
}
impl core::fmt::Debug for FlashremapOffsetDp {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FlashremapOffsetDp")
            .field("flashremap_offset", &self.flashremap_offset())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for FlashremapOffsetDp {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "FlashremapOffsetDp {{ flashremap_offset: {=u32:?} }}",
            self.flashremap_offset()
        )
    }
}
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct FlashremapSize(pub u32);
impl FlashremapSize {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl core::fmt::Debug for FlashremapSize {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FlashremapSize")
            .field("flashremap_size", &self.flashremap_size())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for FlashremapSize {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "FlashremapSize {{ flashremap_size: {=u32:?} }}",
...
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct FlashremapSizeDp(pub u32);
impl FlashremapSizeDp {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
    pub const fn flashremap_size(&self) -> u32 {
...
impl Default for FlashremapSizeDp {
    #[inline(always)]
    fn default() -> FlashremapSizeDp {
        FlashremapSizeDp(0)
    }
}
impl core::fmt::Debug for FlashremapSizeDp {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("FlashremapSizeDp")
            .field("flashremap_size", &self.flashremap_size())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for FlashremapSizeDp {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "FlashremapSizeDp {{ flashremap_size: {=u32:?} }}",
            self.flashremap_size()
        )
    }
}
...
impl Fmccr {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn accel(&self) -> super::vals::Accel {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Accel::from_bits(val as u8)
    }
    #[doc = "Acceleration enable."]
    #[inline(always)]
    pub const fn set_accel(&mut self, val: super::vals::Accel) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Prefetch enable."]
    #[must_use]
    #[inline(always)]
    pub const fn prefen(&self) -> super::vals::Prefen {
        let val = (self.0 >> 5usize) & 0x01;
        super::vals::Prefen::from_bits(val as u8)
    }
    #[doc = "Prefetch enable."]
    #[inline(always)]
    pub const fn set_prefen(&mut self, val: super::vals::Prefen) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val.to_bits() as u32) & 0x01) << 5usize);
    }
...
impl defmt::Format for Fmccr {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Fmccr {{ fetchcfg: {:?}, datacfg: {:?}, accel: {:?}, prefen: {:?}, prefovr: {:?}, flashtim: {:?} }}",
            self.fetchcfg(),
            self.datacfg(),
            self.accel(),
            self.prefen(),
...
impl defmt::Format for Fmcflush {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Fmcflush {{ flush: {:?} }}", self.flush())
    }
}
...
impl Fro1mclkdiv {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn reset(&self) -> super::vals::Fro1mclkdivReset {
        let val = (self.0 >> 29usize) & 0x01;
        super::vals::Fro1mclkdivReset::from_bits(val as u8)
    }
    #[doc = "Resets the divider counter."]
    #[inline(always)]
    pub const fn set_reset(&mut self, val: super::vals::Fro1mclkdivReset) {
        self.0 = (self.0 & !(0x01 << 29usize)) | (((val.to_bits() as u32) & 0x01) << 29usize);
    }
    #[doc = "Halts the divider counter."]
    #[must_use]
    #[inline(always)]
    pub const fn halt(&self) -> super::vals::Fro1mclkdivHalt {
        let val = (self.0 >> 30usize) & 0x01;
        super::vals::Fro1mclkdivHalt::from_bits(val as u8)
    }
    #[doc = "Halts the divider counter."]
    #[inline(always)]
    pub const fn set_halt(&mut self, val: super::vals::Fro1mclkdivHalt) {
        self.0 = (self.0 & !(0x01 << 30usize)) | (((val.to_bits() as u32) & 0x01) << 30usize);
    }
    #[doc = "Divider status flag."]
    #[must_use]
    #[inline(always)]
    pub const fn reqflag(&self) -> super::vals::Fro1mclkdivReqflag {
        let val = (self.0 >> 31usize) & 0x01;
        super::vals::Fro1mclkdivReqflag::from_bits(val as u8)
    }
    #[doc = "Divider status flag."]
    #[inline(always)]
    pub const fn set_reqflag(&mut self, val: super::vals::Fro1mclkdivReqflag) {
        self.0 = (self.0 & !(0x01 << 31usize)) | (((val.to_bits() as u32) & 0x01) << 31usize);
    }
}
...
impl Funcretentionctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn funcretena(&self) -> super::vals::Funcretena {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::Funcretena::from_bits(val as u8)
    }
    #[doc = "functional retention in power down only."]
    #[inline(always)]
    pub const fn set_funcretena(&mut self, val: super::vals::Funcretena) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
...
impl defmt::Format for Funcretentionctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Funcretentionctrl {{ funcretena: {:?}, ret_start: {=u16:?}, ret_lenth: {=u16:?} }}",
            self.funcretena(),
            self.ret_start(),
            self.ret_lenth()
        )
...
impl Default for HmacReg0 {
    #[inline(always)]
    fn default() -> HmacReg0 {
        HmacReg0(0)
    }
}
impl core::fmt::Debug for HmacReg0 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HmacReg0")
            .field("hmac_reg0", &self.hmac_reg0())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for HmacReg0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "HmacReg0 {{ hmac_reg0: {=u32:?} }}", self.hmac_reg0())
    }
}
#[doc = "HMAC"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct HmacReg1(pub u32);
impl HmacReg1 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for HmacReg1 {
    #[inline(always)]
    fn default() -> HmacReg1 {
        HmacReg1(0)
    }
}
impl core::fmt::Debug for HmacReg1 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HmacReg1")
            .field("hmac_reg1", &self.hmac_reg1())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for HmacReg1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "HmacReg1 {{ hmac_reg1: {=u32:?} }}", self.hmac_reg1())
    }
}
#[doc = "HMAC"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct HmacReg2(pub u32);
impl HmacReg2 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for HmacReg2 {
    #[inline(always)]
    fn default() -> HmacReg2 {
        HmacReg2(0)
    }
}
impl core::fmt::Debug for HmacReg2 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HmacReg2")
            .field("hmac_reg2", &self.hmac_reg2())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for HmacReg2 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "HmacReg2 {{ hmac_reg2: {=u32:?} }}", self.hmac_reg2())
    }
}
#[doc = "HMAC"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct HmacReg3(pub u32);
impl HmacReg3 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for HmacReg3 {
    #[inline(always)]
    fn default() -> HmacReg3 {
        HmacReg3(0)
    }
}
impl core::fmt::Debug for HmacReg3 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HmacReg3")
            .field("hmac_reg3", &self.hmac_reg3())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for HmacReg3 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "HmacReg3 {{ hmac_reg3: {=u32:?} }}", self.hmac_reg3())
    }
}
#[doc = "HMAC"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct HmacReg4(pub u32);
impl HmacReg4 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for HmacReg4 {
    #[inline(always)]
    fn default() -> HmacReg4 {
        HmacReg4(0)
    }
}
impl core::fmt::Debug for HmacReg4 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HmacReg4")
            .field("hmac_reg4", &self.hmac_reg4())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for HmacReg4 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "HmacReg4 {{ hmac_reg4: {=u32:?} }}", self.hmac_reg4())
    }
}
#[doc = "HMAC"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct HmacReg5(pub u32);
impl HmacReg5 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for HmacReg5 {
    #[inline(always)]
    fn default() -> HmacReg5 {
        HmacReg5(0)
    }
}
impl core::fmt::Debug for HmacReg5 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HmacReg5")
            .field("hmac_reg5", &self.hmac_reg5())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for HmacReg5 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "HmacReg5 {{ hmac_reg5: {=u32:?} }}", self.hmac_reg5())
    }
}
#[doc = "HMAC"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct HmacReg6(pub u32);
impl HmacReg6 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for HmacReg6 {
    #[inline(always)]
    fn default() -> HmacReg6 {
        HmacReg6(0)
    }
}
impl core::fmt::Debug for HmacReg6 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HmacReg6")
            .field("hmac_reg6", &self.hmac_reg6())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for HmacReg6 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "HmacReg6 {{ hmac_reg6: {=u32:?} }}", self.hmac_reg6())
    }
}
#[doc = "HMAC"]
#[repr(transparent)]
#[derive(Copy, Clone, Eq, PartialEq)]
pub struct HmacReg7(pub u32);
impl HmacReg7 {
    #[doc = "no description available"]
    #[must_use]
    #[inline(always)]
...
impl Default for HmacReg7 {
    #[inline(always)]
    fn default() -> HmacReg7 {
        HmacReg7(0)
    }
}
impl core::fmt::Debug for HmacReg7 {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("HmacReg7")
            .field("hmac_reg7", &self.hmac_reg7())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for HmacReg7 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "HmacReg7 {{ hmac_reg7: {=u32:?} }}", self.hmac_reg7())
    }
}
...
impl Pll0ctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn clken(&self) -> super::vals::Pll0ctrlClken {
        let val = (self.0 >> 21usize) & 0x01;
        super::vals::Pll0ctrlClken::from_bits(val as u8)
    }
    #[doc = "enable the output clock."]
    #[inline(always)]
    pub const fn set_clken(&mut self, val: super::vals::Pll0ctrlClken) {
        self.0 = (self.0 & !(0x01 << 21usize)) | (((val.to_bits() as u32) & 0x01) << 21usize);
    }
    #[doc = "free running mode."]
    #[must_use]
    #[inline(always)]
    pub const fn frmen(&self) -> super::vals::Frmen {
        let val = (self.0 >> 22usize) & 0x01;
        super::vals::Frmen::from_bits(val as u8)
    }
    #[doc = "free running mode."]
    #[inline(always)]
    pub const fn set_frmen(&mut self, val: super::vals::Frmen) {
        self.0 = (self.0 & !(0x01 << 22usize)) | (((val.to_bits() as u32) & 0x01) << 22usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn skewen(&self) -> super::vals::Pll0ctrlSkewen {
        let val = (self.0 >> 24usize) & 0x01;
        super::vals::Pll0ctrlSkewen::from_bits(val as u8)
    }
    #[doc = "skew mode."]
    #[inline(always)]
    pub const fn set_skewen(&mut self, val: super::vals::Pll0ctrlSkewen) {
        self.0 = (self.0 & !(0x01 << 24usize)) | (((val.to_bits() as u32) & 0x01) << 24usize);
    }
}
...
impl defmt::Format for Pll0ctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pll0ctrl {{ selr: {=u8:?}, seli: {=u8:?}, selp: {=u8:?}, bypasspll: {:?}, bypasspostdiv2: {:?}, limupoff: {=bool:?}, bwdirect: {:?}, bypassprediv: {:?}, bypasspostdiv: {:?}, clken: {:?}, frmen: {:?}, frmclkstable: {=bool:?}, skewen: {:?} }}",
            self.selr(),
            self.seli(),
            self.selp(),
            self.bypasspll(),
...
impl Pll1ctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn clken(&self) -> super::vals::Pll1ctrlClken {
        let val = (self.0 >> 21usize) & 0x01;
        super::vals::Pll1ctrlClken::from_bits(val as u8)
    }
    #[doc = "enable the output clock."]
    #[inline(always)]
    pub const fn set_clken(&mut self, val: super::vals::Pll1ctrlClken) {
        self.0 = (self.0 & !(0x01 << 21usize)) | (((val.to_bits() as u32) & 0x01) << 21usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn skewen(&self) -> super::vals::Pll1ctrlSkewen {
        let val = (self.0 >> 24usize) & 0x01;
        super::vals::Pll1ctrlSkewen::from_bits(val as u8)
    }
    #[doc = "Skew mode."]
    #[inline(always)]
    pub const fn set_skewen(&mut self, val: super::vals::Pll1ctrlSkewen) {
        self.0 = (self.0 & !(0x01 << 24usize)) | (((val.to_bits() as u32) & 0x01) << 24usize);
    }
}
...
impl defmt::Format for Pll1ctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pll1ctrl {{ selr: {=u8:?}, seli: {=u8:?}, selp: {=u8:?}, bypasspll: {:?}, bypasspostdiv2: {:?}, limupoff: {=bool:?}, bwdirect: {:?}, bypassprediv: {:?}, bypasspostdiv: {:?}, clken: {:?}, frmen: {=bool:?}, frmclkstable: {=bool:?}, skewen: {:?} }}",
            self.selr(),
            self.seli(),
            self.selp(),
            self.bypasspll(),
...
impl Presetctrl1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn can_rst(&self) -> super::vals::CanRst {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::CanRst::from_bits(val as u8)
    }
    #[doc = "CAN reset control."]
    #[inline(always)]
    pub const fn set_can_rst(&mut self, val: super::vals::CanRst) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
...
impl defmt::Format for Presetctrl1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Presetctrl1 {{ mrt_rst: {:?}, ostimer_rst: {:?}, sct_rst: {:?}, can_rst: {:?}, utick_rst: {:?}, fc_rst[0]: {:?}, fc_rst[1]: {:?}, fc_rst[2]: {:?}, fc_rst[3]: {:?}, fc_rst[4]: {:?}, fc_rst[5]: {:?}, fc_rst[6]: {:?}, fc_rst[7]: {:?}, timer2_rst: {:?}, usb0_dev_rst: {:?}, timer0_rst: {:?}, timer1_rst: {:?} }}",
            self.mrt_rst(),
            self.ostimer_rst(),
            self.sct_rst(),
            self.can_rst(),
...
impl Presetctrl2 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn cdog_rst(&self) -> super::vals::CdogRst {
        let val = (self.0 >> 11usize) & 0x01;
        super::vals::CdogRst::from_bits(val as u8)
    }
    #[doc = "Code Watchdog reset control."]
    #[inline(always)]
    pub const fn set_cdog_rst(&mut self, val: super::vals::CdogRst) {
        self.0 = (self.0 & !(0x01 << 11usize)) | (((val.to_bits() as u32) & 0x01) << 11usize);
    }
