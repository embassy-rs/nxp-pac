...
impl Devcmdstat {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn lpm_sup(&self) -> super::vals::LpmSup {
        let val = (self.0 >> 11usize) & 0x01;
        super::vals::LpmSup::from_bits(val as u8)
    }
    #[doc = "LPM Supported:"]
    #[inline(always)]
    pub const fn set_lpm_sup(&mut self, val: super::vals::LpmSup) {
        self.0 = (self.0 & !(0x01 << 11usize)) | (((val.to_bits() as u32) & 0x01) << 11usize);
    }
    #[doc = "Interrupt on NAK for interrupt and bulk OUT EP"]
    #[must_use]
    #[inline(always)]
    pub const fn intonnak_ao(&self) -> super::vals::IntonnakAo {
        let val = (self.0 >> 12usize) & 0x01;
        super::vals::IntonnakAo::from_bits(val as u8)
    }
    #[doc = "Interrupt on NAK for interrupt and bulk OUT EP"]
    #[inline(always)]
    pub const fn set_intonnak_ao(&mut self, val: super::vals::IntonnakAo) {
        self.0 = (self.0 & !(0x01 << 12usize)) | (((val.to_bits() as u32) & 0x01) << 12usize);
    }
    #[doc = "Interrupt on NAK for interrupt and bulk IN EP"]
    #[must_use]
    #[inline(always)]
    pub const fn intonnak_ai(&self) -> super::vals::IntonnakAi {
        let val = (self.0 >> 13usize) & 0x01;
        super::vals::IntonnakAi::from_bits(val as u8)
    }
    #[doc = "Interrupt on NAK for interrupt and bulk IN EP"]
    #[inline(always)]
    pub const fn set_intonnak_ai(&mut self, val: super::vals::IntonnakAi) {
        self.0 = (self.0 & !(0x01 << 13usize)) | (((val.to_bits() as u32) & 0x01) << 13usize);
    }
    #[doc = "Interrupt on NAK for control OUT EP"]
    #[must_use]
    #[inline(always)]
    pub const fn intonnak_co(&self) -> super::vals::IntonnakCo {
        let val = (self.0 >> 14usize) & 0x01;
        super::vals::IntonnakCo::from_bits(val as u8)
    }
    #[doc = "Interrupt on NAK for control OUT EP"]
    #[inline(always)]
    pub const fn set_intonnak_co(&mut self, val: super::vals::IntonnakCo) {
        self.0 = (self.0 & !(0x01 << 14usize)) | (((val.to_bits() as u32) & 0x01) << 14usize);
    }
    #[doc = "Interrupt on NAK for control IN EP"]
    #[must_use]
    #[inline(always)]
    pub const fn intonnak_ci(&self) -> super::vals::IntonnakCi {
        let val = (self.0 >> 15usize) & 0x01;
        super::vals::IntonnakCi::from_bits(val as u8)
    }
    #[doc = "Interrupt on NAK for control IN EP"]
    #[inline(always)]
    pub const fn set_intonnak_ci(&mut self, val: super::vals::IntonnakCi) {
...
impl defmt::Format for Devcmdstat {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Devcmdstat {{ dev_addr: {=u8:?}, dev_en: {=bool:?}, setup: {=bool:?}, force_needclk: {:?}, lpm_sup: {:?}, intonnak_ao: {:?}, intonnak_ai: {:?}, intonnak_co: {:?}, intonnak_ci: {:?}, dcon: {=bool:?}, dsus: {=bool:?}, lpm_sus: {=bool:?}, lpm_rewp: {=bool:?}, dcon_c: {=bool:?}, dsus_c: {=bool:?}, dres_c: {=bool:?}, vbusdebounced: {=bool:?} }}",
            self.dev_addr(),
            self.dev_en(),
            self.setup(),
            self.force_needclk(),
