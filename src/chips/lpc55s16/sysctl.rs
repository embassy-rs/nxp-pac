...
impl Sysctl {
    ...
    #[inline(always)]
    pub const fn code_gray_lsb(self) -> crate::common::Reg<regs::CodeGrayLsb, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0180usize) as _) }
    }
    #[doc = "CODE_GRAY MSB input Register"]
    #[inline(always)]
    pub const fn code_gray_msb(self) -> crate::common::Reg<regs::CodeGrayMsb, crate::common::RW> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0184usize) as _) }
    }
    #[doc = "CODE_BIN LSB output Register"]
    #[inline(always)]
    pub const fn code_bin_lsb(self) -> crate::common::Reg<regs::CodeBinLsb, crate::common::R> {
        unsafe { crate::common::Reg::from_ptr(self.ptr.wrapping_add(0x0188usize) as _) }
    }
    #[doc = "CODE_BIN MSB output Register"]
    #[inline(always)]
    pub const fn code_bin_msb(self) -> crate::common::Reg<regs::CodeBinMsb, crate::common::R> {
