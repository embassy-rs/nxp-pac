...
impl core::fmt::Debug for CodeBinLsb {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CodeBinLsb")
            .field("code_bin_lsb", &self.code_bin_lsb())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for CodeBinLsb {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CodeBinLsb {{ code_bin_lsb: {=u32:?} }}",
            self.code_bin_lsb()
        )
    }
}
...
impl Default for CodeBinMsb {
    #[inline(always)]
    fn default() -> CodeBinMsb {
        CodeBinMsb(0)
    }
}
impl core::fmt::Debug for CodeBinMsb {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CodeBinMsb")
            .field("code_bin_msb", &self.code_bin_msb())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for CodeBinMsb {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CodeBinMsb {{ code_bin_msb: {=u16:?} }}",
            self.code_bin_msb()
        )
    }
}
...
impl Default for CodeGrayLsb {
    #[inline(always)]
    fn default() -> CodeGrayLsb {
        CodeGrayLsb(0)
    }
}
impl core::fmt::Debug for CodeGrayLsb {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CodeGrayLsb")
            .field("code_gray_lsb", &self.code_gray_lsb())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for CodeGrayLsb {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CodeGrayLsb {{ code_gray_lsb: {=u32:?} }}",
            self.code_gray_lsb()
        )
    }
}
...
impl Default for CodeGrayMsb {
    #[inline(always)]
    fn default() -> CodeGrayMsb {
        CodeGrayMsb(0)
    }
}
impl core::fmt::Debug for CodeGrayMsb {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("CodeGrayMsb")
            .field("code_gray_msb", &self.code_gray_msb())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for CodeGrayMsb {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CodeGrayMsb {{ code_gray_msb: {=u16:?} }}",
            self.code_gray_msb()
        )
    }
}
