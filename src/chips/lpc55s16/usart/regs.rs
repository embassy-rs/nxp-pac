...
impl Cfg {
    ...
    #[doc = "Selects standard or 32 kHz clocking mode."]
    #[inline(always)]
    pub const fn set_mode32k(&mut self, val: super::vals::Mode32k) {
    ...
    #[doc = "LIN break mode enable."]
    #[inline(always)]
    pub const fn set_linmode(&mut self, val: super::vals::Linmode) {
    ...
    #[doc = "Output Enable Turnaround time enable for RS-485 operation."]
    #[inline(always)]
    pub const fn set_oeta(&mut self, val: super::vals::Oeta) {
    ...
    #[doc = "Automatic Address matching enable."]
    #[inline(always)]
    pub const fn set_autoaddr(&mut self, val: super::vals::Autoaddr) {
...
impl defmt::Format for Cfg {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cfg {{ enable: {:?}, datalen: {:?}, paritysel: {:?}, stoplen: {:?}, mode32k: {:?}, linmode: {:?}, ctsen: {:?}, syncen: {:?}, clkpol: {:?}, syncmst: {:?}, loop_: {:?}, oeta: {:?}, autoaddr: {:?}, oesel: {:?}, oepol: {:?}, rxpol: {:?}, txpol: {:?} }}",
            self.enable(),
            self.datalen(),
            self.paritysel(),
            self.stoplen(),
...
impl Ctl {
    ...
    #[doc = "Enable address detect mode."]
    #[inline(always)]
    pub const fn set_addrdet(&mut self, val: super::vals::Addrdet) {
    ...
    #[doc = "Autobaud enable."]
    #[inline(always)]
    pub const fn set_autobaud(&mut self, val: super::vals::Autobaud) {
...
impl defmt::Format for Ctl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ctl {{ txbrken: {:?}, addrdet: {:?}, txdis: {:?}, cc: {:?}, clrcconrx: {:?}, autobaud: {:?} }}",
            self.txbrken(),
            self.addrdet(),
            self.txdis(),
            self.cc(),
...
impl defmt::Format for Fifocfg {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Fifocfg {{ enabletx: {:?}, enablerx: {:?}, size: {=u8:?}, dmatx: {:?}, dmarx: {:?}, waketx: {:?}, wakerx: {:?}, emptytx: {=bool:?}, emptyrx: {=bool:?} }}",
            self.enabletx(),
            self.enablerx(),
            self.size(),
            self.dmatx(),
