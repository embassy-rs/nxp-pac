...
impl AdcCtrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn vbatdivenable(&self) -> super::vals::Vbatdivenable {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::Vbatdivenable::from_bits(val as u8)
    }
    #[doc = "Switch On/Off VBAT divider branch."]
    #[inline(always)]
    pub const fn set_vbatdivenable(&mut self, val: super::vals::Vbatdivenable) {
...
impl defmt::Format for AdcCtrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "AdcCtrl {{ vbatdivenable: {:?} }}", self.vbatdivenable())
    }
}
...
impl AnalogCtrlStatus {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn flash_init_error(&self) -> super::vals::FlashInitError {
        let val = (self.0 >> 13usize) & 0x01;
        super::vals::FlashInitError::from_bits(val as u8)
    }
    #[doc = "Flash initialization error status."]
    #[inline(always)]
    pub const fn set_flash_init_error(&mut self, val: super::vals::FlashInitError) {
...
impl defmt::Format for AnalogCtrlStatus {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "AnalogCtrlStatus {{ flash_pwrdwn: {:?}, flash_init_error: {:?} }}",
            self.flash_pwrdwn(),
...
impl AuxBias {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn vref1venable(&self) -> super::vals::Vref1venable {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::Vref1venable::from_bits(val as u8)
    }
    #[doc = "Control output of 1V reference voltage."]
    #[inline(always)]
    pub const fn set_vref1venable(&mut self, val: super::vals::Vref1venable) {
...
impl defmt::Format for AuxBias {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "AuxBias {{ vref1venable: {:?}, itrim: {=u8:?}, ptatitrim: {=u8:?}, vref1vtrim: {=u8:?}, vref1vcurvetrim: {=u8:?}, itrimctrl0: {=bool:?}, itrimctrl1: {=bool:?} }}",
            self.vref1venable(),
            self.itrim(),
            self.ptatitrim(),
            self.vref1vtrim(),
...
impl BodDcdcIntCtrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn bodvbat_int_enable(&self) -> super::vals::BodvbatIntEnable {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::BodvbatIntEnable::from_bits(val as u8)
    }
    #[doc = "BOD VBAT interrupt control."]
    #[inline(always)]
    pub const fn set_bodvbat_int_enable(&mut self, val: super::vals::BodvbatIntEnable) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn bodcore_int_enable(&self) -> super::vals::BodcoreIntEnable {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::BodcoreIntEnable::from_bits(val as u8)
    }
    #[doc = "BOD CORE interrupt control."]
    #[inline(always)]
    pub const fn set_bodcore_int_enable(&mut self, val: super::vals::BodcoreIntEnable) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dcdc_int_enable(&self) -> super::vals::DcdcIntEnable {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::DcdcIntEnable::from_bits(val as u8)
    }
    #[doc = "DCDC interrupt control."]
    #[inline(always)]
    pub const fn set_dcdc_int_enable(&mut self, val: super::vals::DcdcIntEnable) {
...
impl defmt::Format for BodDcdcIntCtrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BodDcdcIntCtrl {{ bodvbat_int_enable: {:?}, bodvbat_int_clear: {=bool:?}, bodcore_int_enable: {:?}, bodcore_int_clear: {=bool:?}, dcdc_int_enable: {:?}, dcdc_int_clear: {=bool:?} }}",
...
impl BodDcdcIntStatus {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn bodvbat_status(&self) -> super::vals::BodvbatStatus {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::BodvbatStatus::from_bits(val as u8)
    }
    #[doc = "BOD VBAT Interrupt status before Interrupt Enable."]
    #[inline(always)]
    pub const fn set_bodvbat_status(&mut self, val: super::vals::BodvbatStatus) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "BOD VBAT Interrupt status after Interrupt Enable."]
    #[must_use]
    #[inline(always)]
    pub const fn bodvbat_int_status(&self) -> super::vals::BodvbatIntStatus {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::BodvbatIntStatus::from_bits(val as u8)
    }
    #[doc = "BOD VBAT Interrupt status after Interrupt Enable."]
    #[inline(always)]
    pub const fn set_bodvbat_int_status(&mut self, val: super::vals::BodvbatIntStatus) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    #[doc = "Current value of BOD VBAT power status output."]
    #[must_use]
    #[inline(always)]
    pub const fn bodvbat_val(&self) -> super::vals::BodvbatVal {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::BodvbatVal::from_bits(val as u8)
    }
    #[doc = "Current value of BOD VBAT power status output."]
    #[inline(always)]
    pub const fn set_bodvbat_val(&mut self, val: super::vals::BodvbatVal) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "BOD CORE Interrupt status before Interrupt Enable."]
    #[must_use]
    #[inline(always)]
    pub const fn bodcore_status(&self) -> super::vals::BodcoreStatus {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::BodcoreStatus::from_bits(val as u8)
    }
    #[doc = "BOD CORE Interrupt status before Interrupt Enable."]
    #[inline(always)]
    pub const fn set_bodcore_status(&mut self, val: super::vals::BodcoreStatus) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    #[doc = "BOD CORE Interrupt status after Interrupt Enable."]
    #[must_use]
    #[inline(always)]
    pub const fn bodcore_int_status(&self) -> super::vals::BodcoreIntStatus {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::BodcoreIntStatus::from_bits(val as u8)
    }
    #[doc = "BOD CORE Interrupt status after Interrupt Enable."]
    #[inline(always)]
    pub const fn set_bodcore_int_status(&mut self, val: super::vals::BodcoreIntStatus) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Current value of BOD CORE power status output."]
    #[must_use]
    #[inline(always)]
    pub const fn bodcore_val(&self) -> super::vals::BodcoreVal {
        let val = (self.0 >> 5usize) & 0x01;
        super::vals::BodcoreVal::from_bits(val as u8)
    }
    #[doc = "Current value of BOD CORE power status output."]
    #[inline(always)]
    pub const fn set_bodcore_val(&mut self, val: super::vals::BodcoreVal) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val.to_bits() as u32) & 0x01) << 5usize);
    }
    #[doc = "DCDC Interrupt status before Interrupt Enable."]
    #[must_use]
    #[inline(always)]
    pub const fn dcdc_status(&self) -> super::vals::DcdcStatus {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::DcdcStatus::from_bits(val as u8)
    }
    #[doc = "DCDC Interrupt status before Interrupt Enable."]
    #[inline(always)]
    pub const fn set_dcdc_status(&mut self, val: super::vals::DcdcStatus) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u32) & 0x01) << 6usize);
    }
    #[doc = "DCDC Interrupt status after Interrupt Enable."]
    #[must_use]
    #[inline(always)]
    pub const fn dcdc_int_status(&self) -> super::vals::DcdcIntStatus {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::DcdcIntStatus::from_bits(val as u8)
    }
    #[doc = "DCDC Interrupt status after Interrupt Enable."]
    #[inline(always)]
    pub const fn set_dcdc_int_status(&mut self, val: super::vals::DcdcIntStatus) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Current value of DCDC power status output."]
    #[must_use]
    #[inline(always)]
    pub const fn dcdc_val(&self) -> super::vals::DcdcVal {
        let val = (self.0 >> 8usize) & 0x01;
        super::vals::DcdcVal::from_bits(val as u8)
    }
    #[doc = "Current value of DCDC power status output."]
    #[inline(always)]
    pub const fn set_dcdc_val(&mut self, val: super::vals::DcdcVal) {
...
impl defmt::Format for BodDcdcIntStatus {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "BodDcdcIntStatus {{ bodvbat_status: {:?}, bodvbat_int_status: {:?}, bodvbat_val: {:?}, bodcore_status: {:?}, bodcore_int_status: {:?}, bodcore_val: {:?}, dcdc_status: {:?}, dcdc_int_status: {:?}, dcdc_val: {:?} }}",
            self.bodvbat_status(),
...
impl DummyCtrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn xo32m_adc_clk_mode(&self) -> super::vals::Xo32mAdcClkMode {
        let val = (self.0 >> 10usize) & 0x03;
        super::vals::Xo32mAdcClkMode::from_bits(val as u8)
    }
    #[doc = "Control High speed Crystal oscillator mode of the ADC clock."]
    #[inline(always)]
    pub const fn set_xo32m_adc_clk_mode(&mut self, val: super::vals::Xo32mAdcClkMode) {
        self.0 = (self.0 & !(0x03 << 10usize)) | (((val.to_bits() as u32) & 0x03) << 10usize);
    }
}
impl Default for DummyCtrl {
    #[inline(always)]
    fn default() -> DummyCtrl {
        DummyCtrl(0)
    }
}
impl core::fmt::Debug for DummyCtrl {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("DummyCtrl")
            .field("xo32m_adc_clk_mode", &self.xo32m_adc_clk_mode())
            .finish()
    }
}
#[cfg(feature = "defmt")]
impl defmt::Format for DummyCtrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "DummyCtrl {{ xo32m_adc_clk_mode: {:?} }}",
            self.xo32m_adc_clk_mode()
        )
    }
}
...
impl Fro192mCtrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ena_12mhzclk(&self) -> super::vals::Ena12mhzclk {
        let val = (self.0 >> 14usize) & 0x01;
        super::vals::Ena12mhzclk::from_bits(val as u8)
    }
    #[doc = "12 MHz clock control."]
    #[inline(always)]
    pub const fn set_ena_12mhzclk(&mut self, val: super::vals::Ena12mhzclk) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ena_96mhzclk(&self) -> super::vals::Ena96mhzclk {
        let val = (self.0 >> 30usize) & 0x01;
        super::vals::Ena96mhzclk::from_bits(val as u8)
    }
    #[doc = "96 MHz clock control."]
    #[inline(always)]
    pub const fn set_ena_96mhzclk(&mut self, val: super::vals::Ena96mhzclk) {
...
impl defmt::Format for Fro192mCtrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Fro192mCtrl {{ ena_12mhzclk: {:?}, dac_trim: {=u8:?}, usbclkadj: {=bool:?}, usbmodchg: {=bool:?}, ena_96mhzclk: {:?}, wrtrim: {=bool:?} }}",
            self.ena_12mhzclk(),
            self.dac_trim(),
            self.usbclkadj(),
            self.usbmodchg(),
...
impl Fro192mStatus {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn clk_valid(&self) -> super::vals::ClkValid {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::ClkValid::from_bits(val as u8)
    }
    #[doc = "Output clock valid signal. Indicates that CCO clock has settled."]
    #[inline(always)]
    pub const fn set_clk_valid(&mut self, val: super::vals::ClkValid) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
...
impl defmt::Format for Fro192mStatus {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Fro192mStatus {{ clk_valid: {:?}, atb_vctrl: {=bool:?} }}",
            self.clk_valid(),
            self.atb_vctrl()
        )
    }
...
impl defmt::Format for LdoXo32m {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "LdoXo32m {{ bypass: {:?}, highz: {:?}, vout: {:?}, ibias: {=u8:?}, stabmode: {=u8:?} }}",
            self.bypass(),
            self.highz(),
            self.vout(),
            self.ibias(),
...
impl Ringo0Ctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn e_nd0(&self) -> super::vals::ENd0 {
        let val = (self.0 >> 5usize) & 0x01;
        super::vals::ENd0::from_bits(val as u8)
    }
    #[doc = "First NAND2-based ringo control."]
    #[inline(always)]
    pub const fn set_e_nd0(&mut self, val: super::vals::ENd0) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val.to_bits() as u32) & 0x01) << 5usize);
    }
    #[doc = "Second NAND2-based ringo control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_nd1(&self) -> super::vals::ENd1 {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::ENd1::from_bits(val as u8)
    }
    #[doc = "Second NAND2-based ringo control."]
    #[inline(always)]
    pub const fn set_e_nd1(&mut self, val: super::vals::ENd1) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u32) & 0x01) << 6usize);
    }
    #[doc = "First NOR2-based ringo control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_nr0(&self) -> super::vals::ENr0 {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::ENr0::from_bits(val as u8)
    }
    #[doc = "First NOR2-based ringo control."]
    #[inline(always)]
    pub const fn set_e_nr0(&mut self, val: super::vals::ENr0) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Second NOR2-based ringo control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_nr1(&self) -> super::vals::ENr1 {
        let val = (self.0 >> 8usize) & 0x01;
        super::vals::ENr1::from_bits(val as u8)
    }
    #[doc = "Second NOR2-based ringo control."]
    #[inline(always)]
    pub const fn set_e_nr1(&mut self, val: super::vals::ENr1) {
        self.0 = (self.0 & !(0x01 << 8usize)) | (((val.to_bits() as u32) & 0x01) << 8usize);
    }
    #[doc = "First Inverter-based ringo control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_iv0(&self) -> super::vals::EIv0 {
        let val = (self.0 >> 9usize) & 0x01;
        super::vals::EIv0::from_bits(val as u8)
    }
    #[doc = "First Inverter-based ringo control."]
    #[inline(always)]
    pub const fn set_e_iv0(&mut self, val: super::vals::EIv0) {
        self.0 = (self.0 & !(0x01 << 9usize)) | (((val.to_bits() as u32) & 0x01) << 9usize);
    }
    #[doc = "Second Inverter-based ringo control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_iv1(&self) -> super::vals::EIv1 {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::EIv1::from_bits(val as u8)
    }
    #[doc = "Second Inverter-based ringo control."]
    #[inline(always)]
    pub const fn set_e_iv1(&mut self, val: super::vals::EIv1) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
    #[doc = "First PN (P-Transistor and N-Transistor processing) monitor control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_pn0(&self) -> super::vals::EPn0 {
        let val = (self.0 >> 11usize) & 0x01;
        super::vals::EPn0::from_bits(val as u8)
    }
    #[doc = "First PN (P-Transistor and N-Transistor processing) monitor control."]
    #[inline(always)]
    pub const fn set_e_pn0(&mut self, val: super::vals::EPn0) {
        self.0 = (self.0 & !(0x01 << 11usize)) | (((val.to_bits() as u32) & 0x01) << 11usize);
    }
    #[doc = "Second PN (P-Transistor and N-Transistor processing) monitor control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_pn1(&self) -> super::vals::EPn1 {
        let val = (self.0 >> 12usize) & 0x01;
        super::vals::EPn1::from_bits(val as u8)
    }
    #[doc = "Second PN (P-Transistor and N-Transistor processing) monitor control."]
    #[inline(always)]
    pub const fn set_e_pn1(&mut self, val: super::vals::EPn1) {
        self.0 = (self.0 & !(0x01 << 12usize)) | (((val.to_bits() as u32) & 0x01) << 12usize);
    }
...
impl defmt::Format for Ringo0Ctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ringo0Ctrl {{ sl: {:?}, fs: {:?}, swn_swp: {:?}, pd: {:?}, e_nd0: {:?}, e_nd1: {:?}, e_nr0: {:?}, e_nr1: {:?}, e_iv0: {:?}, e_iv1: {:?}, e_pn0: {:?}, e_pn1: {:?}, divisor: {=u8:?}, div_update_req: {=bool:?} }}",
            self.sl(),
            self.fs(),
            self.swn_swp(),
            self.pd(),
...
impl Ringo1Ctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn e_r24(&self) -> super::vals::Ringo1CtrlER24 {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::Ringo1CtrlER24::from_bits(val as u8)
    }
    #[doc = "."]
    #[inline(always)]
    pub const fn set_e_r24(&mut self, val: super::vals::Ringo1CtrlER24) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    #[doc = "."]
    #[must_use]
    #[inline(always)]
    pub const fn e_r35(&self) -> super::vals::Ringo1CtrlER35 {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Ringo1CtrlER35::from_bits(val as u8)
    }
    #[doc = "."]
    #[inline(always)]
    pub const fn set_e_r35(&mut self, val: super::vals::Ringo1CtrlER35) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Metal 2 (M2) monitor control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_m2(&self) -> super::vals::Ringo1CtrlEM2 {
        let val = (self.0 >> 5usize) & 0x01;
        super::vals::Ringo1CtrlEM2::from_bits(val as u8)
    }
    #[doc = "Metal 2 (M2) monitor control."]
    #[inline(always)]
    pub const fn set_e_m2(&mut self, val: super::vals::Ringo1CtrlEM2) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val.to_bits() as u32) & 0x01) << 5usize);
    }
    #[doc = "Metal 3 (M3) monitor control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_m3(&self) -> super::vals::Ringo1CtrlEM3 {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::Ringo1CtrlEM3::from_bits(val as u8)
    }
    #[doc = "Metal 3 (M3) monitor control."]
    #[inline(always)]
    pub const fn set_e_m3(&mut self, val: super::vals::Ringo1CtrlEM3) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u32) & 0x01) << 6usize);
    }
    #[doc = "Metal 4 (M4) monitor control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_m4(&self) -> super::vals::Ringo1CtrlEM4 {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::Ringo1CtrlEM4::from_bits(val as u8)
    }
    #[doc = "Metal 4 (M4) monitor control."]
    #[inline(always)]
    pub const fn set_e_m4(&mut self, val: super::vals::Ringo1CtrlEM4) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Metal 5 (M5) monitor control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_m5(&self) -> super::vals::Ringo1CtrlEM5 {
        let val = (self.0 >> 8usize) & 0x01;
        super::vals::Ringo1CtrlEM5::from_bits(val as u8)
    }
    #[doc = "Metal 5 (M5) monitor control."]
    #[inline(always)]
    pub const fn set_e_m5(&mut self, val: super::vals::Ringo1CtrlEM5) {
        self.0 = (self.0 & !(0x01 << 8usize)) | (((val.to_bits() as u32) & 0x01) << 8usize);
    }
    #[doc = "Ringo out Clock divider value. Frequency Output = Frequency input / (DIViSOR+1). (minimum = Frequency input / 16)"]
    #[must_use]
...
impl defmt::Format for Ringo1Ctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ringo1Ctrl {{ s: {:?}, fs: {:?}, pd: {:?}, e_r24: {:?}, e_r35: {:?}, e_m2: {:?}, e_m3: {:?}, e_m4: {:?}, e_m5: {:?}, divisor: {=u8:?}, div_update_req: {=bool:?} }}",
            self.s(),
            self.fs(),
            self.pd(),
            self.e_r24(),
...
impl Ringo2Ctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn e_r24(&self) -> super::vals::Ringo2CtrlER24 {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::Ringo2CtrlER24::from_bits(val as u8)
    }
    #[doc = "."]
    #[inline(always)]
    pub const fn set_e_r24(&mut self, val: super::vals::Ringo2CtrlER24) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    #[doc = "."]
    #[must_use]
    #[inline(always)]
    pub const fn e_r35(&self) -> super::vals::Ringo2CtrlER35 {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Ringo2CtrlER35::from_bits(val as u8)
    }
    #[doc = "."]
    #[inline(always)]
    pub const fn set_e_r35(&mut self, val: super::vals::Ringo2CtrlER35) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Metal 2 (M2) monitor control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_m2(&self) -> super::vals::Ringo2CtrlEM2 {
        let val = (self.0 >> 5usize) & 0x01;
        super::vals::Ringo2CtrlEM2::from_bits(val as u8)
    }
    #[doc = "Metal 2 (M2) monitor control."]
    #[inline(always)]
    pub const fn set_e_m2(&mut self, val: super::vals::Ringo2CtrlEM2) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val.to_bits() as u32) & 0x01) << 5usize);
    }
    #[doc = "Metal 3 (M3) monitor control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_m3(&self) -> super::vals::Ringo2CtrlEM3 {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::Ringo2CtrlEM3::from_bits(val as u8)
    }
    #[doc = "Metal 3 (M3) monitor control."]
    #[inline(always)]
    pub const fn set_e_m3(&mut self, val: super::vals::Ringo2CtrlEM3) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u32) & 0x01) << 6usize);
    }
    #[doc = "Metal 4 (M4) monitor control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_m4(&self) -> super::vals::Ringo2CtrlEM4 {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::Ringo2CtrlEM4::from_bits(val as u8)
    }
    #[doc = "Metal 4 (M4) monitor control."]
    #[inline(always)]
    pub const fn set_e_m4(&mut self, val: super::vals::Ringo2CtrlEM4) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Metal 5 (M5) monitor control."]
    #[must_use]
    #[inline(always)]
    pub const fn e_m5(&self) -> super::vals::Ringo2CtrlEM5 {
        let val = (self.0 >> 8usize) & 0x01;
        super::vals::Ringo2CtrlEM5::from_bits(val as u8)
    }
    #[doc = "Metal 5 (M5) monitor control."]
    #[inline(always)]
    pub const fn set_e_m5(&mut self, val: super::vals::Ringo2CtrlEM5) {
        self.0 = (self.0 & !(0x01 << 8usize)) | (((val.to_bits() as u32) & 0x01) << 8usize);
    }
    #[doc = "Ringo out Clock divider value. Frequency Output = Frequency input / (DIViSOR+1). (minimum = Frequency input / 16)"]
    #[must_use]
...
impl defmt::Format for Ringo2Ctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ringo2Ctrl {{ s: {:?}, fs: {:?}, pd: {:?}, e_r24: {:?}, e_r35: {:?}, e_m2: {:?}, e_m3: {:?}, e_m4: {:?}, e_m5: {:?}, divisor: {=u8:?}, div_update_req: {=bool:?} }}",
            self.s(),
            self.fs(),
            self.pd(),
            self.e_r24(),
...
impl UsbhsPhyCtrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn iso_atx(&self) -> bool {
        let val = (self.0 >> 3usize) & 0x01;
        val != 0
    }
    #[doc = "."]
    #[inline(always)]
    pub const fn set_iso_atx(&mut self, val: bool) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val as u32) & 0x01) << 3usize);
    }
}
...
impl defmt::Format for UsbhsPhyCtrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "UsbhsPhyCtrl {{ usb_vbusvalid_ext: {=bool:?}, usb_id_ext: {=bool:?}, iso_atx: {=bool:?} }}",
...
impl Xo32mCtrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn acbuf_pass_enable(&self) -> super::vals::AcbufPassEnable {
        let val = (self.0 >> 22usize) & 0x01;
        super::vals::AcbufPassEnable::from_bits(val as u8)
    }
    #[doc = "Bypass enable of XO AC buffer enable in pll and top level."]
    #[inline(always)]
    pub const fn set_acbuf_pass_enable(&mut self, val: super::vals::AcbufPassEnable) {
        self.0 = (self.0 & !(0x01 << 22usize)) | (((val.to_bits() as u32) & 0x01) << 22usize);
    }
    #[doc = "Enable High speed Crystal oscillator output to USB HS PLL."]
    #[must_use]
    #[inline(always)]
    pub const fn enable_pll_usb_out(&self) -> super::vals::EnablePllUsbOut {
        let val = (self.0 >> 23usize) & 0x01;
        super::vals::EnablePllUsbOut::from_bits(val as u8)
    }
    #[doc = "Enable High speed Crystal oscillator output to USB HS PLL."]
    #[inline(always)]
    pub const fn set_enable_pll_usb_out(&mut self, val: super::vals::EnablePllUsbOut) {
        self.0 = (self.0 & !(0x01 << 23usize)) | (((val.to_bits() as u32) & 0x01) << 23usize);
    }
    #[doc = "Enable High speed Crystal oscillator output to CPU system."]
    #[must_use]
    #[inline(always)]
    pub const fn enable_system_clk_out(&self) -> super::vals::EnableSystemClkOut {
        let val = (self.0 >> 24usize) & 0x01;
        super::vals::EnableSystemClkOut::from_bits(val as u8)
    }
    #[doc = "Enable High speed Crystal oscillator output to CPU system."]
    #[inline(always)]
    pub const fn set_enable_system_clk_out(&mut self, val: super::vals::EnableSystemClkOut) {
...
impl defmt::Format for Xo32mCtrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Xo32mCtrl {{ slave: {=bool:?}, osc_cap_in: {=u8:?}, osc_cap_out: {=u8:?}, acbuf_pass_enable: {:?}, enable_pll_usb_out: {:?}, enable_system_clk_out: {:?} }}",
            self.slave(),
            self.osc_cap_in(),
            self.osc_cap_out(),
...
impl Xo32mStatus {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn xo_ready(&self) -> super::vals::XoReady {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::XoReady::from_bits(val as u8)
    }
    #[doc = "Indicates XO out frequency statibilty."]
    #[inline(always)]
    pub const fn set_xo_ready(&mut self, val: super::vals::XoReady) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
}
...
impl defmt::Format for Xo32mStatus {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Xo32mStatus {{ xo_ready: {:?} }}", self.xo_ready())
    }
}
