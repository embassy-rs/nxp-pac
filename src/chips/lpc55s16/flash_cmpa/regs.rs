...
impl CcSocuDflt {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn niden(&self) -> super::vals::CcSocuDfltNiden {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::CcSocuDfltNiden::from_bits(val as u8)
    }
    #[doc = "Non Secure non-invasive debug fixed state"]
    #[inline(always)]
    pub const fn set_niden(&mut self, val: super::vals::CcSocuDfltNiden) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Non Secure debug fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn dbgen(&self) -> super::vals::CcSocuDfltDbgen {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::CcSocuDfltDbgen::from_bits(val as u8)
    }
    #[doc = "Non Secure debug fixed state"]
    #[inline(always)]
    pub const fn set_dbgen(&mut self, val: super::vals::CcSocuDfltDbgen) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    #[doc = "Secure non-invasive debug fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn spniden(&self) -> super::vals::CcSocuDfltSpniden {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::CcSocuDfltSpniden::from_bits(val as u8)
    }
    #[doc = "Secure non-invasive debug fixed state"]
    #[inline(always)]
    pub const fn set_spniden(&mut self, val: super::vals::CcSocuDfltSpniden) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Secure invasive debug fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn spiden(&self) -> super::vals::CcSocuDfltSpiden {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::CcSocuDfltSpiden::from_bits(val as u8)
    }
    #[doc = "Secure invasive debug fixed state"]
    #[inline(always)]
    pub const fn set_spiden(&mut self, val: super::vals::CcSocuDfltSpiden) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    #[doc = "JTAG TAP fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn tapen(&self) -> super::vals::CcSocuDfltTapen {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::CcSocuDfltTapen::from_bits(val as u8)
    }
    #[doc = "JTAG TAP fixed state"]
    #[inline(always)]
    pub const fn set_tapen(&mut self, val: super::vals::CcSocuDfltTapen) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "ISP Boot Command fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn isp_cmd_en(&self) -> super::vals::CcSocuDfltIspCmdEn {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::CcSocuDfltIspCmdEn::from_bits(val as u8)
    }
    #[doc = "ISP Boot Command fixed state"]
    #[inline(always)]
    pub const fn set_isp_cmd_en(&mut self, val: super::vals::CcSocuDfltIspCmdEn) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u32) & 0x01) << 6usize);
    }
    #[doc = "FA Command fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn fa_me_cmd_en(&self) -> super::vals::CcSocuDfltFaMeCmdEn {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::CcSocuDfltFaMeCmdEn::from_bits(val as u8)
    }
    #[doc = "FA Command fixed state"]
    #[inline(always)]
    pub const fn set_fa_me_cmd_en(&mut self, val: super::vals::CcSocuDfltFaMeCmdEn) {
...
impl defmt::Format for CcSocuDflt {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CcSocuDflt {{ niden: {:?}, dbgen: {:?}, spniden: {:?}, spiden: {:?}, tapen: {:?}, isp_cmd_en: {:?}, fa_me_cmd_en: {:?}, inverse_value: {=u16:?} }}",
            self.niden(),
            self.dbgen(),
            self.spniden(),
            self.spiden(),
...
impl CcSocuPin {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn fa_me_cmd_en(&self) -> super::vals::CcSocuPinFaMeCmdEn {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::CcSocuPinFaMeCmdEn::from_bits(val as u8)
    }
    #[doc = "FA Command enable"]
    #[inline(always)]
    pub const fn set_fa_me_cmd_en(&mut self, val: super::vals::CcSocuPinFaMeCmdEn) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
...
impl defmt::Format for CcSocuPin {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "CcSocuPin {{ niden: {:?}, dbgen: {:?}, spniden: {:?}, spiden: {:?}, tapen: {:?}, isp_cmd_en: {:?}, fa_me_cmd_en: {:?}, uuid_check: {=bool:?}, inverse_value: {=u16:?} }}",
            self.niden(),
            self.dbgen(),
            self.spniden(),
            self.spiden(),
...
impl defmt::Format for FlashRemapOffset {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "FlashRemapOffset {{ field: {=u32:?} }}", self.field())
    }
}
...
impl defmt::Format for FlashRemapSize {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "FlashRemapSize {{ field: {=u32:?} }}", self.field())
    }
}
#[doc = "no description available"]
#[repr(transparent)]
...
impl SecureBootCfg {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dice_inc_sec_epoch(&self) -> super::vals::DiceIncSecEpoch {
        let val = (self.0 >> 14usize) & 0x03;
        super::vals::DiceIncSecEpoch::from_bits(val as u8)
    }
    #[doc = "Include security EPOCH in DICE"]
    #[inline(always)]
    pub const fn set_dice_inc_sec_epoch(&mut self, val: super::vals::DiceIncSecEpoch) {
        self.0 = (self.0 & !(0x03 << 14usize)) | (((val.to_bits() as u32) & 0x03) << 14usize);
    }
    #[doc = "Skip boot seed computation"]
    #[must_use]
    #[inline(always)]
    pub const fn skip_boot_seed(&self) -> super::vals::SkipBootSeed {
        let val = (self.0 >> 16usize) & 0x03;
        super::vals::SkipBootSeed::from_bits(val as u8)
    }
    #[doc = "Skip boot seed computation"]
    #[inline(always)]
    pub const fn set_skip_boot_seed(&mut self, val: super::vals::SkipBootSeed) {
        self.0 = (self.0 & !(0x03 << 16usize)) | (((val.to_bits() as u32) & 0x03) << 16usize);
    }
    #[doc = "Include NXP area in BOOT SEED computation"]
    #[must_use]
    #[inline(always)]
    pub const fn boot_seed_inc_nxp_cfg(&self) -> super::vals::BootSeedIncNxpCfg {
        let val = (self.0 >> 18usize) & 0x03;
        super::vals::BootSeedIncNxpCfg::from_bits(val as u8)
    }
    #[doc = "Include NXP area in BOOT SEED computation"]
    #[inline(always)]
    pub const fn set_boot_seed_inc_nxp_cfg(&mut self, val: super::vals::BootSeedIncNxpCfg) {
        self.0 = (self.0 & !(0x03 << 18usize)) | (((val.to_bits() as u32) & 0x03) << 18usize);
    }
    #[doc = "Include CMPA area in BOOT SEED computation"]
    #[must_use]
    #[inline(always)]
    pub const fn boot_seed_cust_cfg(&self) -> super::vals::BootSeedCustCfg {
        let val = (self.0 >> 20usize) & 0x03;
        super::vals::BootSeedCustCfg::from_bits(val as u8)
    }
    #[doc = "Include CMPA area in BOOT SEED computation"]
    #[inline(always)]
    pub const fn set_boot_seed_cust_cfg(&mut self, val: super::vals::BootSeedCustCfg) {
        self.0 = (self.0 & !(0x03 << 20usize)) | (((val.to_bits() as u32) & 0x03) << 20usize);
    }
    #[doc = "Include security epoch area in BOOT_SEED computation."]
    #[must_use]
    #[inline(always)]
    pub const fn boot_seed_inc_epoch(&self) -> super::vals::BootSeedIncEpoch {
        let val = (self.0 >> 22usize) & 0x03;
        super::vals::BootSeedIncEpoch::from_bits(val as u8)
    }
    #[doc = "Include security epoch area in BOOT_SEED computation."]
    #[inline(always)]
    pub const fn set_boot_seed_inc_epoch(&mut self, val: super::vals::BootSeedIncEpoch) {
...
impl defmt::Format for SecureBootCfg {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "SecureBootCfg {{ rsa4k: {:?}, dice_inc_nxp_cfg: {:?}, dice_cust_cfg: {:?}, skip_dice: {:?}, tzm_image_type: {:?}, block_set_key: {:?}, block_enroll: {:?}, dice_inc_sec_epoch: {:?}, skip_boot_seed: {:?}, boot_seed_inc_nxp_cfg: {:?}, boot_seed_cust_cfg: {:?}, boot_seed_inc_epoch: {:?}, sec_boot_en: {:?} }}",
            self.rsa4k(),
