...
impl Cfg1 {
    ...
    #[doc = "Main enable for I 2S function in this Flexcomm"]
    #[inline(always)]
    pub const fn set_mainenable(&mut self, val: super::vals::Mainenable) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn onechannel(&self) -> super::vals::Cfg1Onechannel {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::Cfg1Onechannel::from_bits(val as u8)
    }
    #[doc = "Single channel mode. Applies to both transmit and receive. This configuration bit applies only to the first I2S channel pair. Other channel pairs may select this mode independently in their separate CFG1 registers."]
    #[inline(always)]
    pub const fn set_onechannel(&mut self, val: super::vals::Cfg1Onechannel) {
    ...
    #[doc = "WS polarity."]
    #[inline(always)]
    pub const fn set_ws_pol(&mut self, val: super::vals::WsPol) {
...
impl defmt::Format for Cfg1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Cfg1 {{ mainenable: {:?}, datapause: {:?}, paircount: {:?}, mstslvcfg: {:?}, mode: {:?}, rightlow: {:?}, leftjust: {:?}, onechannel: {:?}, sck_pol: {:?}, ws_pol: {:?}, datalen: {=u8:?} }}",
            self.mainenable(),
            self.datapause(),
            self.paircount(),
            self.mstslvcfg(),
...
impl Fifocfg {
    ...
    #[doc = "Enable the transmit FIFO."]
    #[inline(always)]
    pub const fn set_enabletx(&mut self, val: super::vals::Enabletx) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    ...
    #[doc = "Enable the receive FIFO."]
    #[inline(always)]
    pub const fn set_enablerx(&mut self, val: super::vals::Enablerx) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    ...
    #[doc = "DMA configuration for transmit."]
    #[inline(always)]
    pub const fn set_dmatx(&mut self, val: super::vals::Dmatx) {
        self.0 = (self.0 & !(0x01 << 12usize)) | (((val.to_bits() as u32) & 0x01) << 12usize);
    }
    ...
    #[doc = "DMA configuration for receive."]
    #[inline(always)]
    pub const fn set_dmarx(&mut self, val: super::vals::Dmarx) {
        self.0 = (self.0 & !(0x01 << 13usize)) | (((val.to_bits() as u32) & 0x01) << 13usize);
    }
    ...
    #[doc = "Wake-up for transmit FIFO level. This allows the device to be woken from reduced power modes (up to power-down, as long as the peripheral function works in that power mode) without enabling the TXLVL interrupt. Only DMA wakes up, processes data, and goes back to sleep. The CPU will remain stopped until woken by another cause, such as DMA completion. See Hardware Wake-up control register."]
    #[inline(always)]
    pub const fn set_waketx(&mut self, val: super::vals::Waketx) {
    ...
    #[doc = "Wake-up for receive FIFO level. This allows the device to be woken from reduced power modes (up to power-down, as long as the peripheral function works in that power mode) without enabling the TXLVL interrupt. Only DMA wakes up, processes data, and goes back to sleep. The CPU will remain stopped until woken by another cause, such as DMA completion. See Hardware Wake-up control register."]
    #[inline(always)]
    pub const fn set_wakerx(&mut self, val: super::vals::Wakerx) {
...
impl defmt::Format for Fifocfg {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Fifocfg {{ enabletx: {:?}, enablerx: {:?}, txi2se0: {:?}, pack48: {:?}, size: {=u8:?}, dmatx: {:?}, dmarx: {:?}, waketx: {:?}, wakerx: {:?}, emptytx: {=bool:?}, emptyrx: {=bool:?} }}",
            self.enabletx(),
            self.enablerx(),
            self.txi2se0(),
            self.pack48(),
...
impl Fifointenset {
    ...
    #[doc = "Determines whether an interrupt occurs when a transmit error occurs, based on the TXERR flag in the FIFOSTAT register."]
    #[inline(always)]
    pub const fn set_txerr(&mut self, val: super::vals::Txerr) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    ...
    #[doc = "Determines whether an interrupt occurs when a receive error occurs, based on the RXERR flag in the FIFOSTAT register."]
    #[inline(always)]
    pub const fn set_rxerr(&mut self, val: super::vals::Rxerr) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    ...
    #[doc = "Determines whether an interrupt occurs when a the transmit FIFO reaches the level specified by the TXLVL field in the FIFOTRIG register."]
    #[inline(always)]
    pub const fn set_txlvl(&mut self, val: super::vals::Txlvl) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    ...
    #[doc = "Determines whether an interrupt occurs when a the receive FIFO reaches the level specified by the TXLVL field in the FIFOTRIG register."]
    #[inline(always)]
    pub const fn set_rxlvl(&mut self, val: super::vals::Rxlvl) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
}
...
impl defmt::Format for Fifointenset {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Fifointenset {{ txerr: {:?}, rxerr: {:?}, txlvl: {:?}, rxlvl: {:?} }}",
            self.txerr(),
            self.rxerr(),
            self.txlvl(),
            self.rxlvl()
...
impl Fifotrig {
    ...
    #[doc = "Transmit FIFO level trigger enable. This trigger will become an interrupt if enabled in FIFOINTENSET, or a DMA trigger if DMATX in FIFOCFG is set."]
    #[inline(always)]
    pub const fn set_txlvlena(&mut self, val: super::vals::Txlvlena) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    ...
    #[doc = "Receive FIFO level trigger enable. This trigger will become an interrupt if enabled in FIFOINTENSET, or a DMA trigger if DMARX in FIFOCFG is set."]
    #[inline(always)]
    pub const fn set_rxlvlena(&mut self, val: super::vals::Rxlvlena) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
...
impl defmt::Format for Fifotrig {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Fifotrig {{ txlvlena: {:?}, rxlvlena: {:?}, txlvl: {=u8:?}, rxlvl: {=u8:?} }}",
            self.txlvlena(),
            self.rxlvlena(),
            self.txlvl(),
            self.rxlvl()
...
impl Pcfg1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pairenable(&self) -> super::vals::Pairenable {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::Pairenable::from_bits(val as u8)
    }
    #[doc = "Enable for this channel pair."]
    #[inline(always)]
    pub const fn set_pairenable(&mut self, val: super::vals::Pairenable) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Single channel mode."]
    #[must_use]
    #[inline(always)]
    pub const fn onechannel(&self) -> super::vals::Pcfg1Onechannel {
        let val = (self.0 >> 10usize) & 0x01;
        super::vals::Pcfg1Onechannel::from_bits(val as u8)
    }
    #[doc = "Single channel mode."]
    #[inline(always)]
    pub const fn set_onechannel(&mut self, val: super::vals::Pcfg1Onechannel) {
        self.0 = (self.0 & !(0x01 << 10usize)) | (((val.to_bits() as u32) & 0x01) << 10usize);
    }
}
...
impl Pstat {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn busy(&self) -> super::vals::PstatBusy {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::PstatBusy::from_bits(val as u8)
    }
    #[doc = "Busy status for this channel pair."]
    #[inline(always)]
    pub const fn set_busy(&mut self, val: super::vals::PstatBusy) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn datapaused(&self) -> super::vals::PstatDatapaused {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::PstatDatapaused::from_bits(val as u8)
    }
    #[doc = "Data Paused status flag."]
    #[inline(always)]
    pub const fn set_datapaused(&mut self, val: super::vals::PstatDatapaused) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
}
...
impl defmt::Format for Pstat {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pstat {{ busy: {:?}, slvfrmerr: {=bool:?}, lr: {=bool:?}, datapaused: {:?} }}",
            self.busy(),
            self.slvfrmerr(),
            self.lr(),
            self.datapaused()
...
impl Stat {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn busy(&self) -> super::vals::StatBusy {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::StatBusy::from_bits(val as u8)
    }
    #[doc = "Busy status for the primary channel pair. Other BUSY flags may be found in the STAT register for each channel pair."]
    #[inline(always)]
    pub const fn set_busy(&mut self, val: super::vals::StatBusy) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    ...
    #[doc = "Slave Frame Error flag. This applies when at least one channel pair is operating as a slave. An error indicates that the incoming WS signal did not transition as expected due to a mismatch between FRAMELEN and the actual incoming I2S stream."]
    #[inline(always)]
    pub const fn set_slvfrmerr(&mut self, val: super::vals::Slvfrmerr) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn datapaused(&self) -> super::vals::StatDatapaused {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::StatDatapaused::from_bits(val as u8)
    }
    #[doc = "Data Paused status flag. Applies to all I2S channels"]
    #[inline(always)]
    pub const fn set_datapaused(&mut self, val: super::vals::StatDatapaused) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
}
...
impl defmt::Format for Stat {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Stat {{ busy: {:?}, slvfrmerr: {:?}, lr: {:?}, datapaused: {:?} }}",
            self.busy(),
            self.slvfrmerr(),
            self.lr(),
            self.datapaused()
