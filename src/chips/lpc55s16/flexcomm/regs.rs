...
impl Pselid {
    ...
    #[doc = "USART present indicator. This field is Read-only."]
    #[inline(always)]
    pub const fn set_usartpresent(&mut self, val: super::vals::Usartpresent) {
    ...
    #[doc = "I 2S present indicator. This field is Read-only."]
    #[inline(always)]
    pub const fn set_i2spresent(&mut self, val: super::vals::I2spresent) {
...
impl defmt::Format for Pselid {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pselid {{ persel: {:?}, lock: {:?}, usartpresent: {:?}, spipresent: {:?}, i2cpresent: {:?}, i2spresent: {:?}, id: {=u32:?} }}",
            self.persel(),
            self.lock(),
            self.usartpresent(),
            self.spipresent(),
