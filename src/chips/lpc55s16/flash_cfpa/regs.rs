...
impl DcfgCcSocuDflt {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn niden(&self) -> super::vals::DcfgCcSocuDfltNiden {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::DcfgCcSocuDfltNiden::from_bits(val as u8)
    }
    #[doc = "Non Secure non-invasive debug fixed state"]
    #[inline(always)]
    pub const fn set_niden(&mut self, val: super::vals::DcfgCcSocuDfltNiden) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Non Secure debug fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn dbgen(&self) -> super::vals::DcfgCcSocuDfltDbgen {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::DcfgCcSocuDfltDbgen::from_bits(val as u8)
    }
    #[doc = "Non Secure debug fixed state"]
    #[inline(always)]
    pub const fn set_dbgen(&mut self, val: super::vals::DcfgCcSocuDfltDbgen) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    #[doc = "Secure non-invasive debug fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn spniden(&self) -> super::vals::DcfgCcSocuDfltSpniden {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::DcfgCcSocuDfltSpniden::from_bits(val as u8)
    }
    #[doc = "Secure non-invasive debug fixed state"]
    #[inline(always)]
    pub const fn set_spniden(&mut self, val: super::vals::DcfgCcSocuDfltSpniden) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Secure invasive debug fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn spiden(&self) -> super::vals::DcfgCcSocuDfltSpiden {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::DcfgCcSocuDfltSpiden::from_bits(val as u8)
    }
    #[doc = "Secure invasive debug fixed state"]
    #[inline(always)]
    pub const fn set_spiden(&mut self, val: super::vals::DcfgCcSocuDfltSpiden) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    #[doc = "JTAG TAP fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn tapen(&self) -> super::vals::DcfgCcSocuDfltTapen {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::DcfgCcSocuDfltTapen::from_bits(val as u8)
    }
    #[doc = "JTAG TAP fixed state"]
    #[inline(always)]
    pub const fn set_tapen(&mut self, val: super::vals::DcfgCcSocuDfltTapen) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "ISP Boot Command fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn isp_cmd_en(&self) -> super::vals::DcfgCcSocuDfltIspCmdEn {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::DcfgCcSocuDfltIspCmdEn::from_bits(val as u8)
    }
    #[doc = "ISP Boot Command fixed state"]
    #[inline(always)]
    pub const fn set_isp_cmd_en(&mut self, val: super::vals::DcfgCcSocuDfltIspCmdEn) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u32) & 0x01) << 6usize);
    }
    #[doc = "FA Command fixed state"]
    #[must_use]
    #[inline(always)]
    pub const fn fa_me_cmd_en(&self) -> super::vals::DcfgCcSocuDfltFaMeCmdEn {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::DcfgCcSocuDfltFaMeCmdEn::from_bits(val as u8)
    }
    #[doc = "FA Command fixed state"]
    #[inline(always)]
    pub const fn set_fa_me_cmd_en(&mut self, val: super::vals::DcfgCcSocuDfltFaMeCmdEn) {
...
impl defmt::Format for DcfgCcSocuDflt {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "DcfgCcSocuDflt {{ niden: {:?}, dbgen: {:?}, spniden: {:?}, spiden: {:?}, tapen: {:?}, isp_cmd_en: {:?}, fa_me_cmd_en: {:?}, inverse_value: {=u16:?} }}",
            self.niden(),
            self.dbgen(),
            self.spniden(),
            self.spiden(),
...
impl DcfgCcSocuPin {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn fa_me_cmd_en(&self) -> super::vals::DcfgCcSocuPinFaMeCmdEn {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::DcfgCcSocuPinFaMeCmdEn::from_bits(val as u8)
    }
    #[doc = "FA Command enable"]
    #[inline(always)]
    pub const fn set_fa_me_cmd_en(&mut self, val: super::vals::DcfgCcSocuPinFaMeCmdEn) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
...
impl defmt::Format for DcfgCcSocuPin {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "DcfgCcSocuPin {{ niden: {:?}, dbgen: {:?}, spniden: {:?}, spiden: {:?}, tapen: {:?}, isp_cmd_en: {:?}, fa_me_cmd_en: {:?}, uuid_check: {=bool:?}, inverse_value: {=u16:?} }}",
            self.niden(),
            self.dbgen(),
            self.spniden(),
            self.spiden(),
