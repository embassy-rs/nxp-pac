...
impl Comp {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn hyst(&self) -> super::vals::CompHyst {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::CompHyst::from_bits(val as u8)
    }
    #[doc = "Hysteris when hyst = '1'."]
    #[inline(always)]
    pub const fn set_hyst(&mut self, val: super::vals::CompHyst) {
...
impl defmt::Format for Comp {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Comp {{ hyst: {:?}, vrefinput: {:?}, lowpower: {:?}, pmux: {:?}, nmux: {:?}, vref: {=u8:?}, filtercgf_samplemode: {:?}, filtercgf_clkdiv: {:?} }}",
            self.hyst(),
            self.vrefinput(),
            self.lowpower(),
            self.pmux(),
...
impl Ldopmu {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn bleed(&self) -> super::vals::Bleed {
        let val = (self.0 >> 20usize) & 0x01;
        super::vals::Bleed::from_bits(val as u8)
    }
    #[doc = "Controls LDOMEM bleed current."]
    #[inline(always)]
    pub const fn set_bleed(&mut self, val: super::vals::Bleed) {
        self.0 = (self.0 & !(0x01 << 20usize)) | (((val.to_bits() as u32) & 0x01) << 20usize);
    }
    #[doc = "Control the LDO AO boost mode in ACTIVE mode."]
    #[must_use]
    #[inline(always)]
    pub const fn boost_ena(&self) -> super::vals::BoostEna {
        let val = (self.0 >> 24usize) & 0x01;
        super::vals::BoostEna::from_bits(val as u8)
    }
    #[doc = "Control the LDO AO boost mode in ACTIVE mode."]
    #[inline(always)]
    pub const fn set_boost_ena(&mut self, val: super::vals::BoostEna) {
        self.0 = (self.0 & !(0x01 << 24usize)) | (((val.to_bits() as u32) & 0x01) << 24usize);
    }
    #[doc = "Control the LDO AO boost mode in the different low power modes (DEEP SLEEP, POWERDOWN, and DEEP POWER DOWN)."]
    #[must_use]
    #[inline(always)]
    pub const fn boost_ena_pwd(&self) -> super::vals::BoostEnaPwd {
        let val = (self.0 >> 25usize) & 0x01;
        super::vals::BoostEnaPwd::from_bits(val as u8)
    }
    #[doc = "Control the LDO AO boost mode in the different low power modes (DEEP SLEEP, POWERDOWN, and DEEP POWER DOWN)."]
    #[inline(always)]
    pub const fn set_boost_ena_pwd(&mut self, val: super::vals::BoostEnaPwd) {
...
impl defmt::Format for Ldopmu {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ldopmu {{ vadj: {:?}, vadj_pwd: {=u8:?}, vadj_boost: {=u8:?}, vadj_boost_pwd: {=u8:?}, bleed: {:?}, boost_ena: {:?}, boost_ena_pwd: {:?} }}",
            self.vadj(),
            self.vadj_pwd(),
            self.vadj_boost(),
            self.vadj_boost_pwd(),
...
impl Miscctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn ldomemhighzmode(&self) -> super::vals::Ldomemhighzmode {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::Ldomemhighzmode::from_bits(val as u8)
    }
    #[doc = "Control the activation of LDO MEM High Z mode."]
    #[inline(always)]
    pub const fn set_ldomemhighzmode(&mut self, val: super::vals::Ldomemhighzmode) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
...
impl defmt::Format for Miscctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Miscctrl {{ ldodeepsleepref: {:?}, ldomemhighzmode: {:?}, lowpwr_flash_buf: {=bool:?}, miscctrl_3_11: {=u16:?}, disable_bleed: {:?}, miscctrl_13_15: {=u8:?} }}",
...
impl Reffastwkup {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn lpwkup(&self) -> super::vals::Lpwkup {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::Lpwkup::from_bits(val as u8)
    }
    #[doc = "Analog References fast wake-up in case of wake-up from a low power mode (DEEP SLEEP, POWER DOWN and DEEP POWER DOWN): ."]
    #[inline(always)]
    pub const fn set_lpwkup(&mut self, val: super::vals::Lpwkup) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Analog References fast wake-up in case of Hardware Pin reset: ."]
    #[must_use]
    #[inline(always)]
    pub const fn hwwkup(&self) -> super::vals::Hwwkup {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::Hwwkup::from_bits(val as u8)
    }
    #[doc = "Analog References fast wake-up in case of Hardware Pin reset: ."]
    #[inline(always)]
    pub const fn set_hwwkup(&mut self, val: super::vals::Hwwkup) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
}
...
impl Resetctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dpdwakeupresetenable(&self) -> super::vals::Dpdwakeupresetenable {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::Dpdwakeupresetenable::from_bits(val as u8)
    }
    #[doc = "Wake-up from DEEP POWER DOWN reset event (either from wake up I/O or RTC or OS Event Timer)."]
    #[inline(always)]
    pub const fn set_dpdwakeupresetenable(&mut self, val: super::vals::Dpdwakeupresetenable) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Software reset enable."]
    #[must_use]
    #[inline(always)]
    pub const fn swrresetenable(&self) -> super::vals::Swrresetenable {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::Swrresetenable::from_bits(val as u8)
    }
    #[doc = "Software reset enable."]
    #[inline(always)]
    pub const fn set_swrresetenable(&mut self, val: super::vals::Swrresetenable) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    #[doc = "BOD VBAT reset enable."]
    #[must_use]
    #[inline(always)]
    pub const fn bodvbatresetena_secure(&self) -> super::vals::BodvbatresetenaSecure {
        let val = (self.0 >> 4usize) & 0x03;
        super::vals::BodvbatresetenaSecure::from_bits(val as u8)
    }
    #[doc = "BOD VBAT reset enable."]
    #[inline(always)]
    pub const fn set_bodvbatresetena_secure(&mut self, val: super::vals::BodvbatresetenaSecure) {
        self.0 = (self.0 & !(0x03 << 4usize)) | (((val.to_bits() as u32) & 0x03) << 4usize);
    }
    #[doc = "BOD Core reset enable."]
    #[must_use]
    #[inline(always)]
    pub const fn bodcoreresetena_secure(&self) -> super::vals::BodcoreresetenaSecure {
        let val = (self.0 >> 6usize) & 0x03;
        super::vals::BodcoreresetenaSecure::from_bits(val as u8)
    }
    #[doc = "BOD Core reset enable."]
    #[inline(always)]
    pub const fn set_bodcoreresetena_secure(&mut self, val: super::vals::BodcoreresetenaSecure) {
        self.0 = (self.0 & !(0x03 << 6usize)) | (((val.to_bits() as u32) & 0x03) << 6usize);
    }
    #[doc = "BOD VBAT reset enable."]
    #[must_use]
    #[inline(always)]
    pub const fn bodvbatresetena_secure_dp(&self) -> super::vals::BodvbatresetenaSecureDp {
        let val = (self.0 >> 28usize) & 0x03;
        super::vals::BodvbatresetenaSecureDp::from_bits(val as u8)
    }
    #[doc = "BOD VBAT reset enable."]
    #[inline(always)]
    pub const fn set_bodvbatresetena_secure_dp(
        &mut self,
        val: super::vals::BodvbatresetenaSecureDp,
    ) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn bodcoreresetena_secure_dp(&self) -> super::vals::BodcoreresetenaSecureDp {
        let val = (self.0 >> 30usize) & 0x03;
        super::vals::BodcoreresetenaSecureDp::from_bits(val as u8)
    }
    #[doc = "BOD Core reset enable."]
    #[inline(always)]
    pub const fn set_bodcoreresetena_secure_dp(
        &mut self,
        val: super::vals::BodcoreresetenaSecureDp,
    ) {
...
impl defmt::Format for Resetctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Resetctrl {{ dpdwakeupresetenable: {:?}, swrresetenable: {:?}, bodvbatresetena_secure: {:?}, bodcoreresetena_secure: {:?}, bodvbatresetena_secure_dp: {:?}, bodcoreresetena_secure_dp: {:?} }}",
...
impl Wakeiocause {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn wakeup0(&self) -> super::vals::Wakeup0 {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::Wakeup0::from_bits(val as u8)
    }
    #[doc = "Allows to identify Wake up I/O 0 as the wake-up source from Deep Power Down mode."]
    #[inline(always)]
    pub const fn set_wakeup0(&mut self, val: super::vals::Wakeup0) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Allows to identify Wake up I/O 1 as the wake-up source from Deep Power Down mode."]
    #[must_use]
    #[inline(always)]
    pub const fn wakeup1(&self) -> super::vals::Wakeup1 {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::Wakeup1::from_bits(val as u8)
    }
    #[doc = "Allows to identify Wake up I/O 1 as the wake-up source from Deep Power Down mode."]
    #[inline(always)]
    pub const fn set_wakeup1(&mut self, val: super::vals::Wakeup1) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    #[doc = "Allows to identify Wake up I/O 2 as the wake-up source from Deep Power Down mode."]
    #[must_use]
    #[inline(always)]
    pub const fn wakeup2(&self) -> super::vals::Wakeup2 {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Wakeup2::from_bits(val as u8)
    }
    #[doc = "Allows to identify Wake up I/O 2 as the wake-up source from Deep Power Down mode."]
    #[inline(always)]
    pub const fn set_wakeup2(&mut self, val: super::vals::Wakeup2) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Allows to identify Wake up I/O 3 as the wake-up source from Deep Power Down mode."]
    #[must_use]
    #[inline(always)]
    pub const fn wakeup3(&self) -> super::vals::Wakeup3 {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::Wakeup3::from_bits(val as u8)
    }
    #[doc = "Allows to identify Wake up I/O 3 as the wake-up source from Deep Power Down mode."]
    #[inline(always)]
    pub const fn set_wakeup3(&mut self, val: super::vals::Wakeup3) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
}
...
impl defmt::Format for Wakeiocause {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Wakeiocause {{ wakeup0: {:?}, wakeup1: {:?}, wakeup2: {:?}, wakeup3: {:?} }}",
            self.wakeup0(),
            self.wakeup1(),
            self.wakeup2(),
            self.wakeup3()
...
impl Wakeupioctrl {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn risingedgewakeup0(&self) -> super::vals::Risingedgewakeup0 {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::Risingedgewakeup0::from_bits(val as u8)
    }
    #[doc = "Enable / disable detection of rising edge events on Wake Up 0 pin in Deep Power Down modes:."]
    #[inline(always)]
    pub const fn set_risingedgewakeup0(&mut self, val: super::vals::Risingedgewakeup0) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Enable / disable detection of falling edge events on Wake Up 0 pin in Deep Power Down modes:."]
    #[must_use]
    #[inline(always)]
    pub const fn fallingedgewakeup0(&self) -> super::vals::Fallingedgewakeup0 {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::Fallingedgewakeup0::from_bits(val as u8)
    }
    #[doc = "Enable / disable detection of falling edge events on Wake Up 0 pin in Deep Power Down modes:."]
    #[inline(always)]
    pub const fn set_fallingedgewakeup0(&mut self, val: super::vals::Fallingedgewakeup0) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    #[doc = "Enable / disable detection of rising edge events on Wake Up 1 pin in Deep Power Down modes:."]
    #[must_use]
    #[inline(always)]
    pub const fn risingedgewakeup1(&self) -> super::vals::Risingedgewakeup1 {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Risingedgewakeup1::from_bits(val as u8)
    }
    #[doc = "Enable / disable detection of rising edge events on Wake Up 1 pin in Deep Power Down modes:."]
    #[inline(always)]
    pub const fn set_risingedgewakeup1(&mut self, val: super::vals::Risingedgewakeup1) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Enable / disable detection of falling edge events on Wake Up 1 pin in Deep Power Down modes:."]
    #[must_use]
    #[inline(always)]
    pub const fn fallingedgewakeup1(&self) -> super::vals::Fallingedgewakeup1 {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::Fallingedgewakeup1::from_bits(val as u8)
    }
    #[doc = "Enable / disable detection of falling edge events on Wake Up 1 pin in Deep Power Down modes:."]
    #[inline(always)]
    pub const fn set_fallingedgewakeup1(&mut self, val: super::vals::Fallingedgewakeup1) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    #[doc = "Enable / disable detection of rising edge events on Wake Up 2 pin in Deep Power Down modes:."]
    #[must_use]
    #[inline(always)]
    pub const fn risingedgewakeup2(&self) -> super::vals::Risingedgewakeup2 {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Risingedgewakeup2::from_bits(val as u8)
    }
    #[doc = "Enable / disable detection of rising edge events on Wake Up 2 pin in Deep Power Down modes:."]
    #[inline(always)]
    pub const fn set_risingedgewakeup2(&mut self, val: super::vals::Risingedgewakeup2) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Enable / disable detection of falling edge events on Wake Up 2 pin in Deep Power Down modes:."]
    #[must_use]
    #[inline(always)]
    pub const fn fallingedgewakeup2(&self) -> super::vals::Fallingedgewakeup2 {
        let val = (self.0 >> 5usize) & 0x01;
        super::vals::Fallingedgewakeup2::from_bits(val as u8)
    }
    #[doc = "Enable / disable detection of falling edge events on Wake Up 2 pin in Deep Power Down modes:."]
    #[inline(always)]
    pub const fn set_fallingedgewakeup2(&mut self, val: super::vals::Fallingedgewakeup2) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val.to_bits() as u32) & 0x01) << 5usize);
    }
    #[doc = "Enable / disable detection of rising edge events on Wake Up 3 pin in Deep Power Down modes:."]
    #[must_use]
    #[inline(always)]
    pub const fn risingedgewakeup3(&self) -> super::vals::Risingedgewakeup3 {
        let val = (self.0 >> 6usize) & 0x01;
        super::vals::Risingedgewakeup3::from_bits(val as u8)
    }
    #[doc = "Enable / disable detection of rising edge events on Wake Up 3 pin in Deep Power Down modes:."]
    #[inline(always)]
    pub const fn set_risingedgewakeup3(&mut self, val: super::vals::Risingedgewakeup3) {
        self.0 = (self.0 & !(0x01 << 6usize)) | (((val.to_bits() as u32) & 0x01) << 6usize);
    }
    #[doc = "Enable / disable detection of falling edge events on Wake Up 3 pin in Deep Power Down modes:."]
    #[must_use]
    #[inline(always)]
    pub const fn fallingedgewakeup3(&self) -> super::vals::Fallingedgewakeup3 {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::Fallingedgewakeup3::from_bits(val as u8)
    }
    #[doc = "Enable / disable detection of falling edge events on Wake Up 3 pin in Deep Power Down modes:."]
    #[inline(always)]
    pub const fn set_fallingedgewakeup3(&mut self, val: super::vals::Fallingedgewakeup3) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    ...
    #[must_use]
    #[inline(always)]
    pub const fn wakeupio_enable_ctrl(&self) -> super::vals::WakeupioEnableCtrl {
        let val = (self.0 >> 20usize) & 0x01;
        super::vals::WakeupioEnableCtrl::from_bits(val as u8)
    }
    #[doc = "Enable WAKEUP IO PAD control from MODEWAKEUPIOPAD (bits 12 to 19)."]
    #[inline(always)]
    pub const fn set_wakeupio_enable_ctrl(&mut self, val: super::vals::WakeupioEnableCtrl) {
        self.0 = (self.0 & !(0x01 << 20usize)) | (((val.to_bits() as u32) & 0x01) << 20usize);
    }
    #[doc = "WAKEUP IO event detector reset control."]
    #[must_use]
    #[inline(always)]
    pub const fn wakeupio_rstn(&self) -> super::vals::WakeupioRstn {
        let val = (self.0 >> 21usize) & 0x01;
        super::vals::WakeupioRstn::from_bits(val as u8)
    }
    #[doc = "WAKEUP IO event detector reset control."]
    #[inline(always)]
    pub const fn set_wakeupio_rstn(&mut self, val: super::vals::WakeupioRstn) {
...
impl defmt::Format for Wakeupioctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Wakeupioctrl {{ risingedgewakeup0: {:?}, fallingedgewakeup0: {:?}, risingedgewakeup1: {:?}, fallingedgewakeup1: {:?}, risingedgewakeup2: {:?}, fallingedgewakeup2: {:?}, risingedgewakeup3: {:?}, fallingedgewakeup3: {:?}, modewakeupiopad0: {:?}, modewakeupiopad1: {:?}, modewakeupiopad2: {:?}, modewakeupiopad3: {:?}, wakeupio_enable_ctrl: {:?}, wakeupio_rstn: {:?} }}",
