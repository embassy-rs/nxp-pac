...
impl defmt::Format for EncEnable {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "EncEnable {{ en: {:?} }}", self.en())
    }
}
...
impl defmt::Format for Err {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(f, "Err {{ errstat: {:?} }}", self.errstat())
    }
}
...
impl Lock {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn lockreg0(&self) -> super::vals::Lockreg0 {
        let val = (self.0 >> 0usize) & 0x01;
        super::vals::Lockreg0::from_bits(val as u8)
    }
    #[doc = "Lock Region 0 registers."]
    #[inline(always)]
    pub const fn set_lockreg0(&mut self, val: super::vals::Lockreg0) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    #[doc = "Lock Region 1 registers."]
    #[must_use]
    #[inline(always)]
    pub const fn lockreg1(&self) -> super::vals::Lockreg1 {
        let val = (self.0 >> 1usize) & 0x01;
        super::vals::Lockreg1::from_bits(val as u8)
    }
    #[doc = "Lock Region 1 registers."]
    #[inline(always)]
    pub const fn set_lockreg1(&mut self, val: super::vals::Lockreg1) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    #[doc = "Lock Region 2 registers."]
    #[must_use]
    #[inline(always)]
    pub const fn lockreg2(&self) -> super::vals::Lockreg2 {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Lockreg2::from_bits(val as u8)
    }
    #[doc = "Lock Region 2 registers."]
    #[inline(always)]
    pub const fn set_lockreg2(&mut self, val: super::vals::Lockreg2) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Lock the Mask registers."]
    #[must_use]
    #[inline(always)]
    pub const fn lockmask(&self) -> super::vals::Lockmask {
        let val = (self.0 >> 8usize) & 0x01;
        super::vals::Lockmask::from_bits(val as u8)
    }
    #[doc = "Lock the Mask registers."]
    #[inline(always)]
    pub const fn set_lockmask(&mut self, val: super::vals::Lockmask) {
...
impl defmt::Format for Lock {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Lock {{ lockreg0: {:?}, lockreg1: {:?}, lockreg2: {:?}, lockmask: {:?} }}",
            self.lockreg0(),
            self.lockreg1(),
            self.lockreg2(),
            self.lockmask()
