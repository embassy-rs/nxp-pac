...
impl Default for IdxblkDp {
    #[inline(always)]
    fn default() -> IdxblkDp {
        IdxblkDp(0)
    }
}
impl core::fmt::Debug for IdxblkDp {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdxblkDp")
            .field("idx0", &self.idx0())
            .field("idx1", &self.idx1())
            .field("idx2", &self.idx2())
            .field("idx3", &self.idx3())
...
#[cfg(feature = "defmt")]
impl defmt::Format for IdxblkDp {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "IdxblkDp {{ idx0: {=u8:?}, idx1: {=u8:?}, idx2: {=u8:?}, idx3: {=u8:?}, idx4: {=u8:?}, idx5: {=u8:?}, idx6: {=u8:?}, idx7: {=u8:?}, idx8: {=u8:?}, idx9: {=u8:?}, idx10: {=u8:?}, idx11: {=u8:?}, idx12: {=u8:?}, idx13: {=u8:?}, idx14: {=u8:?}, idx15: {=u8:?} }}",
            self.idx0(),
            self.idx1(),
            self.idx2(),
            self.idx3(),
...
impl Default for IdxblkStatus {
    #[inline(always)]
    fn default() -> IdxblkStatus {
        IdxblkStatus(0)
    }
}
impl core::fmt::Debug for IdxblkStatus {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("IdxblkStatus")
            .field("idx0", &self.idx0())
            .field("idx1", &self.idx1())
            .field("idx2", &self.idx2())
            .field("idx3", &self.idx3())
...
#[cfg(feature = "defmt")]
impl defmt::Format for IdxblkStatus {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "IdxblkStatus {{ idx0: {=u8:?}, idx1: {=u8:?}, idx2: {=u8:?}, idx3: {=u8:?}, idx4: {=u8:?}, idx5: {=u8:?}, idx6: {=u8:?}, idx7: {=u8:?}, idx8: {=u8:?}, idx9: {=u8:?}, idx10: {=u8:?}, idx11: {=u8:?}, idx12: {=u8:?}, idx13: {=u8:?}, idx14: {=u8:?}, idx15: {=u8:?} }}",
            self.idx0(),
            self.idx1(),
            self.idx2(),
            self.idx3(),
