...
impl Ctrl {
    ...
    #[doc = "Written with 1 when starting a new Hash/Crypto. It self clears. Note that the WAITING Status bit will clear for a cycle during the initialization from New=1."]
    #[inline(always)]
    pub const fn set_new_hash(&mut self, val: super::vals::NewHash) {
    ...
    #[doc = "Written to 1 to use DMA to drain the digest/output. If both DMA_I and DMA_O are set, the DMA has to know to switch direction and the locations. This can be used for crypto uses."]
    #[inline(always)]
    pub const fn set_dma_o(&mut self, val: super::vals::DmaO) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn aesflush(&self) -> super::vals::Aesflush {
        let val = (self.0 >> 13usize) & 0x01;
        super::vals::Aesflush::from_bits(val as u8)
    }
    #[doc = "Flushes the AES engine registers. This bit self clears."]
    #[inline(always)]
    pub const fn set_aesflush(&mut self, val: super::vals::Aesflush) {
...
impl defmt::Format for Ctrl {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Ctrl {{ mode: {:?}, new_hash: {:?}, reload: {:?}, dma_i: {:?}, dma_o: {:?}, hashswpb: {=bool:?}, aesflush: {:?} }}",
            self.mode(),
            self.new_hash(),
            self.reload(),
            self.dma_i(),
...
impl Intenset {
    ...
    #[doc = "Indicates if should interrupt when waiting for data input."]
    #[inline(always)]
    pub const fn set_waiting(&mut self, val: super::vals::IntensetWaiting) {
    ...
    #[doc = "Indicates if should interrupt when Digest (or Outdata) is ready (completed a hash/crypto or completed a full sequence)."]
    #[inline(always)]
    pub const fn set_digest(&mut self, val: super::vals::IntensetDigest) {
    ...
    #[doc = "Indicates if should interrupt on an ERROR (as defined in Status)"]
    #[inline(always)]
    pub const fn set_error(&mut self, val: super::vals::IntensetError) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Indicates if should interrupt on an AES or PRNG fault as indicated in the STATUS register"]
    #[must_use]
    #[inline(always)]
    pub const fn fault(&self) -> super::vals::IntensetFault {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::IntensetFault::from_bits(val as u8)
    }
    #[doc = "Indicates if should interrupt on an AES or PRNG fault as indicated in the STATUS register"]
    #[inline(always)]
    pub const fn set_fault(&mut self, val: super::vals::IntensetFault) {
...
impl defmt::Format for Intenset {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Intenset {{ waiting: {:?}, digest: {:?}, error: {:?}, fault: {:?} }}",
            self.waiting(),
            self.digest(),
            self.error(),
            self.fault()
...
impl Status {
    ...
    #[doc = "If 1, the block is waiting for more data to process."]
    #[inline(always)]
    pub const fn set_waiting(&mut self, val: super::vals::StatusWaiting) {
        self.0 = (self.0 & !(0x01 << 0usize)) | (((val.to_bits() as u32) & 0x01) << 0usize);
    }
    ...
    #[doc = "For Hash, if 1 then a DIGEST is ready and waiting and there is no active next block already started. For Cryptographic uses, this will be set for each block processed, indicating OUTDATA (and OUTDATA2 if larger output) contains the next value to read out. This is cleared when any data is written, when New is written, for Cryptographic uses when the last word is read out, or when the block is disabled."]
    #[inline(always)]
    pub const fn set_digest(&mut self, val: super::vals::StatusDigest) {
        self.0 = (self.0 & !(0x01 << 1usize)) | (((val.to_bits() as u32) & 0x01) << 1usize);
    }
    ...
    #[doc = "If 1, an error occurred. For normal uses, this is due to an attempted overrun: INDATA was written when it was not appropriate. For Master cases, this is an AHB bus error; the COUNT field will indicate which block it was on."]
    #[inline(always)]
    pub const fn set_error(&mut self, val: super::vals::StatusError) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Indicates if an AES or PRNG fault has occurred"]
    #[must_use]
    #[inline(always)]
    pub const fn fault(&self) -> super::vals::StatusFault {
        let val = (self.0 >> 3usize) & 0x01;
        super::vals::StatusFault::from_bits(val as u8)
    }
    #[doc = "Indicates if an AES or PRNG fault has occurred"]
    #[inline(always)]
    pub const fn set_fault(&mut self, val: super::vals::StatusFault) {
        self.0 = (self.0 & !(0x01 << 3usize)) | (((val.to_bits() as u32) & 0x01) << 3usize);
    }
    ...
    #[doc = "Indicates the block wants the key to be written in (set along with WAITING)"]
    #[inline(always)]
    pub const fn set_needkey(&mut self, val: super::vals::Needkey) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    ...
    #[doc = "Indicates the block wants an IV/NONE to be written in (set along with WAITING)"]
    #[inline(always)]
    pub const fn set_neediv(&mut self, val: super::vals::Neediv) {
        self.0 = (self.0 & !(0x01 << 5usize)) | (((val.to_bits() as u32) & 0x01) << 5usize);
    }
    #[doc = "AES fault status"]
    #[must_use]
    #[inline(always)]
    pub const fn aesfault(&self) -> super::vals::Aesfault {
        let val = (self.0 >> 8usize) & 0x01;
        super::vals::Aesfault::from_bits(val as u8)
    }
    #[doc = "AES fault status"]
    #[inline(always)]
    pub const fn set_aesfault(&mut self, val: super::vals::Aesfault) {
        self.0 = (self.0 & !(0x01 << 8usize)) | (((val.to_bits() as u32) & 0x01) << 8usize);
    }
    #[doc = "PRNG fault status"]
    #[must_use]
    #[inline(always)]
    pub const fn prngfault(&self) -> super::vals::Prngfault {
        let val = (self.0 >> 9usize) & 0x01;
        super::vals::Prngfault::from_bits(val as u8)
    }
    #[doc = "PRNG fault status"]
    #[inline(always)]
    pub const fn set_prngfault(&mut self, val: super::vals::Prngfault) {
        self.0 = (self.0 & !(0x01 << 9usize)) | (((val.to_bits() as u32) & 0x01) << 9usize);
    }
}
...
impl defmt::Format for Status {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Status {{ waiting: {:?}, digest: {:?}, error: {:?}, fault: {:?}, needkey: {:?}, neediv: {:?}, aesfault: {:?}, prngfault: {:?} }}",
            self.waiting(),
            self.digest(),
            self.error(),
            self.fault(),
