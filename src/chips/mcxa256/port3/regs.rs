...
impl Pcr0 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pfe(&self) -> super::vals::Pcr0Pfe {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Pcr0Pfe::from_bits(val as u8)
    }
    #[doc = "Passive Filter Enable"]
    #[inline(always)]
    pub const fn set_pfe(&mut self, val: super::vals::Pcr0Pfe) {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dse1(&self) -> super::vals::Pcr0Dse1 {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::Pcr0Dse1::from_bits(val as u8)
    }
    #[doc = "Drive Strength Enable"]
    #[inline(always)]
    pub const fn set_dse1(&mut self, val: super::vals::Pcr0Dse1) {
...
impl defmt::Format for Pcr0 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr0 {{ ps: {:?}, pe: {:?}, sre: {:?}, pfe: {:?}, ode: {:?}, dse: {:?}, dse1: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.pfe(),
...
impl Pcr1 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pfe(&self) -> super::vals::Pcr1Pfe {
        let val = (self.0 >> 4usize) & 0x01;
        super::vals::Pcr1Pfe::from_bits(val as u8)
    }
    #[doc = "Passive Filter Enable"]
    #[inline(always)]
    pub const fn set_pfe(&mut self, val: super::vals::Pcr1Pfe) {
        self.0 = (self.0 & !(0x01 << 4usize)) | (((val.to_bits() as u32) & 0x01) << 4usize);
    }
    #[doc = "Open Drain Enable"]
    #[must_use]
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dse1(&self) -> super::vals::Pcr1Dse1 {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::Pcr1Dse1::from_bits(val as u8)
    }
    #[doc = "Drive Strength Enable"]
    #[inline(always)]
    pub const fn set_dse1(&mut self, val: super::vals::Pcr1Dse1) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Pin Multiplex Control"]
    #[must_use]
...
impl defmt::Format for Pcr1 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr1 {{ ps: {:?}, pe: {:?}, sre: {:?}, pfe: {:?}, ode: {:?}, dse: {:?}, dse1: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.pfe(),
...
impl Pcr18 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr18Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr18Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr18Pv) {
...
impl defmt::Format for Pcr18 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr18 {{ ps: {:?}, pe: {:?}, pv: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.sre(),
...
impl Pcr19 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr19Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr19Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr19Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Slew Rate Enable"]
    #[must_use]
...
impl defmt::Format for Pcr19 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr19 {{ ps: {:?}, pe: {:?}, pv: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.sre(),
...
impl Pcr25 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr25Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr25Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr25Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Slew Rate Enable"]
    #[must_use]
...
impl defmt::Format for Pcr25 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr25 {{ ps: {:?}, pe: {:?}, pv: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.sre(),
...
impl Pcr26 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr26Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr26Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr26Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Slew Rate Enable"]
    #[must_use]
...
impl defmt::Format for Pcr26 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr26 {{ ps: {:?}, pe: {:?}, pv: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.sre(),
...
impl Pcr27 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dse1(&self) -> super::vals::Pcr27Dse1 {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::Pcr27Dse1::from_bits(val as u8)
    }
    #[doc = "Drive Strength Enable"]
    #[inline(always)]
    pub const fn set_dse1(&mut self, val: super::vals::Pcr27Dse1) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Pin Multiplex Control"]
    #[must_use]
...
impl defmt::Format for Pcr27 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr27 {{ ps: {:?}, pe: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, dse1: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.ode(),
...
impl Pcr28 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn dse1(&self) -> super::vals::Pcr28Dse1 {
        let val = (self.0 >> 7usize) & 0x01;
        super::vals::Pcr28Dse1::from_bits(val as u8)
    }
    #[doc = "Drive Strength Enable"]
    #[inline(always)]
    pub const fn set_dse1(&mut self, val: super::vals::Pcr28Dse1) {
        self.0 = (self.0 & !(0x01 << 7usize)) | (((val.to_bits() as u32) & 0x01) << 7usize);
    }
    #[doc = "Pin Multiplex Control"]
    #[must_use]
...
impl defmt::Format for Pcr28 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr28 {{ ps: {:?}, pe: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, dse1: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.ode(),
...
impl Pcr29 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr29Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr29Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr29Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Slew Rate Enable"]
    #[must_use]
...
impl defmt::Format for Pcr29 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr29 {{ ps: {:?}, pe: {:?}, pv: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.sre(),
...
impl Pcr31 {
    ...
    #[must_use]
    #[inline(always)]
    pub const fn pv(&self) -> super::vals::Pcr31Pv {
        let val = (self.0 >> 2usize) & 0x01;
        super::vals::Pcr31Pv::from_bits(val as u8)
    }
    #[doc = "Pull Value"]
    #[inline(always)]
    pub const fn set_pv(&mut self, val: super::vals::Pcr31Pv) {
        self.0 = (self.0 & !(0x01 << 2usize)) | (((val.to_bits() as u32) & 0x01) << 2usize);
    }
    #[doc = "Slew Rate Enable"]
    #[must_use]
...
impl defmt::Format for Pcr31 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr31 {{ ps: {:?}, pe: {:?}, pv: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, mux: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.pv(),
            self.sre(),
