...
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum MdatactrlFlushfb {
    #[doc = "No action"]
    NO_ACTION = 0x0,
    #[doc = "Flush the buffer"]
    FLUSH = 0x01,
}
impl MdatactrlFlushfb {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> MdatactrlFlushfb {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for MdatactrlFlushfb {
    ...
    fn from(val: u8) -> MdatactrlFlushfb {
        MdatactrlFlushfb::from_bits(val)
    }
}
impl From<MdatactrlFlushfb> for u8 {
    #[inline(always)]
    fn from(val: MdatactrlFlushfb) -> u8 {
        MdatactrlFlushfb::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum MdatactrlFlushtb {
    #[doc = "No action"]
    NO_ACTION = 0x0,
    #[doc = "Flush the buffer"]
    FLUSH = 0x01,
}
impl MdatactrlFlushtb {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> MdatactrlFlushtb {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum SdatactrlFlushfb {
    #[doc = "No action"]
    NO_ACTION = 0x0,
    #[doc = "Flush the buffer"]
    FLUSH = 0x01,
}
impl SdatactrlFlushfb {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SdatactrlFlushfb {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
...
impl From<u8> for SdatactrlFlushfb {
    ...
    fn from(val: u8) -> SdatactrlFlushfb {
        SdatactrlFlushfb::from_bits(val)
    }
}
impl From<SdatactrlFlushfb> for u8 {
    #[inline(always)]
    fn from(val: SdatactrlFlushfb) -> u8 {
        SdatactrlFlushfb::to_bits(val)
    }
}
#[repr(u8)]
#[derive(Copy, Clone, Debug, Eq, PartialEq, Ord, PartialOrd)]
#[cfg_attr(feature = "defmt", derive(defmt::Format))]
pub enum SdatactrlFlushtb {
    #[doc = "No action"]
    NO_ACTION = 0x0,
    #[doc = "Flush the buffer"]
    FLUSH = 0x01,
}
impl SdatactrlFlushtb {
    #[inline(always)]
    pub const fn from_bits(val: u8) -> SdatactrlFlushtb {
        unsafe { core::mem::transmute(val & 0x01) }
    }
    #[inline(always)]
    pub const fn to_bits(self) -> u8 {
