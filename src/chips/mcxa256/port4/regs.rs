...
impl defmt::Format for Pcr12 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr12 {{ ps: {:?}, pe: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.ode(),
...
impl defmt::Format for Pcr13 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr13 {{ ps: {:?}, pe: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.ode(),
...
impl defmt::Format for Pcr14 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr14 {{ ps: {:?}, pe: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.ode(),
...
impl defmt::Format for Pcr15 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr15 {{ ps: {:?}, pe: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.ode(),
...
impl defmt::Format for Pcr16 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr16 {{ ps: {:?}, pe: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.ode(),
...
impl defmt::Format for Pcr17 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr17 {{ ps: {:?}, pe: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.ode(),
...
impl defmt::Format for Pcr18 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr18 {{ ps: {:?}, pe: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.ode(),
...
impl defmt::Format for Pcr19 {
    fn format(&self, f: defmt::Formatter) {
        defmt::write!(
            f,
            "Pcr19 {{ ps: {:?}, pe: {:?}, sre: {:?}, ode: {:?}, dse: {:?}, ibe: {:?}, inv: {:?}, lk: {:?} }}",
            self.ps(),
            self.pe(),
            self.sre(),
            self.ode(),
